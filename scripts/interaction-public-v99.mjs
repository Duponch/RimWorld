...
try{
 ...
 await page.screenshot({path:'artifacts/interaction-v99-public.png'});
...
finally{await writeFile('artifacts/interaction-public-v99.json',JSON.stringify(report,null,2));await browser.close();console.log(JSON.stringify(report));}

...
function fixture(count: number, withWork: boolean): World {
  ...
  world.pawns = Array.from({ length: count }, (_, index) => ({
    ...
    hunger: 100, rest: 100, mood: 100, jobId: null, haul: null, need: null, bedId: null, needCooldown: 0, state: 'idle' as const,
    priorities: { gather: 2, build: 2, haul: 3 }, path: [], moveCooldown: 0, planCooldown: 0,
  }));

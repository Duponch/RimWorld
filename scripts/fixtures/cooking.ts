...
export function cookingFixture(count:number) {
  ...
  w.pawns=Array.from({length:count},(_,i)=>{
    ...
    return {...structuredClone(template),id:w.nextId++,x:x+i%5,z,hunger:100,rest:100,priorities: { patient:0,bedrest:0,doctor:0,craft:2,mine:0,gather:0,build:2,haul:2,grow:2,cook:1}};
  });

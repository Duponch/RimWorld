...
if(reference&&!['v96','v98','v113','v114'].includes(reference))throw Error('Unknown reference; archive the documented source revision first');
...
try{
 ...
 report.baseline=reference?(reference==='v114'?'0e7c0c4':reference==='v113'?'9866b60':reference==='v98'?'d5cb6f7':'c9010ec'):baseline?'f993e3a':bundleBaseline?'5bd1af3 (render adapter bypassed)':null;

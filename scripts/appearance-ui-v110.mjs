...
try {
  ...
  await page.screenshot({path:'artifacts/appearance-v110-bio.png'});
  ...
  for(const [name,position] of [['front',[14,9,31]],['side',[32,9,12]],['back',[14,9,-5]]]){
    ...
    await page.waitForTimeout(300);await page.screenshot({path:`artifacts/appearance-v110-${name}.png`});report.images.push(name);
  }
  ...
  writeFileSync('artifacts/appearance-ui-v110.json',JSON.stringify(report,null,2)+'\n');console.log(JSON.stringify(report));

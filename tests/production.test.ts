...
function camp():World {
  ...
  w.pawns.forEach((p,i)=>Object.assign(p,{x:2+i*2,z:2,hunger:100,rest:100,priorities:{gather:0,build:1,haul:1,grow:0, cook: 0 }}));
...
test('feu construit, deux jours de combustion, ravitaillement concurrent et interruption conservent le bois',()=>{
  ...
  const historical=JSON.parse(serializeWorld(w));historical.schemaVersion=9;

...
test('a rejected item already on a stockpile can leave for a lower-priority accepting stockpile',()=>{
  ...
  w.jobs=[];pawn.priorities={clean:0,firefight:0,warden:0,basic:0,hunt:0,research:0,patient:0,bedrest:0,doctor:0,mine:0,craft:0,gather:0,build:0,haul:1,grow:0,cook:0};

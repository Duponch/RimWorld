...
function camp(count=1):World {
  ...
  for(const [i,p] of w.pawns.entries()){
    ...
    p.priorities={handle:0,clean:0,firefight:0,warden:0,basic:3,hunt:0,research:0,patient:0,bedrest:0,doctor:0,gather:0,build:0,mine:0,grow:0,haul:0,cook:0,art:0,craft:i?0:1};

...
test('Affectations : régime partagé, copie, refus de suppression, faim, migration et commandes acquittées',async({playwright},testInfo)=>{
  ...
  try {
    ...
    fixture.pawns.forEach((p,i)=>{p.x=12+i*3;p.z=13;p.hunger=19;p.rest=100;p.priorities={handle:0,clean:0,firefight:0,warden:0,basic:3,hunt:0,research:0, patient:0,bedrest:0,doctor:0,art:0,craft:2,mine:2,gather:0,build:0,haul:0,grow:0,cook:0};});

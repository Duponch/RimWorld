...
function camp(): World {
  ...
  Object.assign(w.pawns[0]!, {x: 2, z: 2, rest: 70, hunger: 90, priorities: {handle:0,clean:0,firefight:0,warden:0,basic:3,hunt:0,research:0, patient:0,bedrest:0,doctor:0,art:0,craft:2,mine:2,gather: 0, build: 0, haul: 0, grow: 0, cook: 0}});
  const bed = {id: w.nextId++, kind: 'bed' as const, x: 10, z: 10, orientation: 0 as const, footprint: 'standard' as const, quality: 'normal' as const};

...
const fixture=()=>{
  ...
  w.pawns.forEach((p,i)=>{Object.assign(p,{x:8+i*2,z:14,hunger:100,rest:100,priorities: {warden:0,basic:3,hunt:0,research:0, patient:0,bedrest:0,doctor:0,craft:2,mine:2,gather:0,build:0,haul:0,grow:0,cook:0}});p.schedule.fill('recreation');p.recreation=initialRecreation(10);});

...
export function orderCamp(count=2):World {
  ...
  w.pawns.forEach((p,i)=>{p.x=12+i*2;p.z=16;p.hunger=100;p.rest=100;p.schedule.fill('anything');p.priorities={research:0, patient:0,bedrest:0,doctor:0,craft:2,mine:2,build:1,haul:0,gather:1,grow:1,cook:0};});

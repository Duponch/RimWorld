...
test('logistics proves only competitive access, retains ties and skips an inaccessible higher-priority reserve',()=>{
  const setup=()=>{
    const w=deconstructionCamp(1,64),p=w.pawns[0]!;p.x=10;p.z=10;p.priorities={research:0, patient:0,bedrest:0,doctor:0,mine:0,craft:0,gather:0,build:0,haul:1,grow:0,cook:0};

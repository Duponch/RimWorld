...
function camp():World {
  ...
  const p=w.pawns[0]!;Object.assign(p,{x:5,z:5,hunger:100,rest:100});p.priorities={clean:0,firefight:0,warden:0,basic:3,hunt:0,research:0,patient:0,bedrest:0,doctor:0,gather:0,build:0,mine:0,grow:1,haul:2,cook:0,art:0,craft:0};refreshStock(w);return w;
}

...
export function doorTraffic(count:number):World {
  ...
  w.pawns.forEach((p,i)=>{
    ...
    p.x=x-3;p.z=z;p.priorities={clean:0,firefight:0,warden:0,basic:3,hunt:0,research:0, patient:0,bedrest:0,doctor:0,mine:0,craft:0,gather:2,build:1,haul:2,grow:0,cook:0};

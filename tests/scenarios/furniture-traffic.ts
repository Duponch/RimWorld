...
export function furnitureTrafficFixture() {
  ...
  for(const [i,p] of w.pawns.entries())Object.assign(p,{x:i?14:1,z:8,hunger:100,rest:100,schedule:Array(24).fill('anything'),priorities:{mine:2,build:0,gather:0,grow:0,cook:0,haul:1}});

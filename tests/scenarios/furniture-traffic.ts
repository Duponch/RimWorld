...
export function furnitureTrafficFixture() {
  ...
  for(const [i,p] of w.pawns.entries())Object.assign(p,{x:i?14:1,z:8,hunger:100,rest:100,schedule:Array(24).fill('anything'),priorities: {firefight:0,warden:0,basic:3,hunt:0,research:0, patient:0,bedrest:0,doctor:0,craft:2,mine:2,build:0,gather:0,grow:0,cook:0,haul:1}});

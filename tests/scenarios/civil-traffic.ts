...
export function civilCrossingFixture(): World {
  ...
  w.pawns.forEach((p,i)=>{
    Object.assign(p,{x:[2,13,8][i]!,z:8,hunger:100,rest:10,priorities: {research:0, patient:0,bedrest:0,doctor:0,craft:2,mine:2,gather:0,build:0,haul:0,grow:0,cook:0}});

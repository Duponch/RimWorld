...
export function powerFixture():World {
  ...
  w.pawns[0]!.priorities={clean:0,firefight:0,warden:0,basic:3,hunt:0,research:0, patient:0,bedrest:0,doctor:0,build:1,haul:2,mine:0,gather:0,grow:0,cook:0,art:0,craft:0};

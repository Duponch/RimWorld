...
export function roomExperienceCamp():World {
  ...
  p.schedule.fill('anything');p.priorities={handle:0,clean:0,firefight:0,warden:0,basic:0,hunt:0,research:0,patient:0,bedrest:0,doctor:0,art:0,craft:0,mine:0,gather:0,build:0,haul:0,grow:0,cook:0};

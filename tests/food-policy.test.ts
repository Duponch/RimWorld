...
function camp():World {
  ...
  Object.assign(w.pawns[0]!,{x:2,z:2,hunger:20,rest:100,priorities: {clean:0,firefight:0,warden:0,basic:3,hunt:0,research:0, patient:0,bedrest:0,doctor:0,craft:2,mine:2,gather:0,build:0,haul:0,grow:0,cook:0}});refreshStock(w);return w;
}

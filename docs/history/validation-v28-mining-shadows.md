# Validation historique — V28, minage et préparation des ombres

15 septembre 2026. G0 en consolidation, G1 partiel, première tranche de minage G2. [Contrat](../development/mining.md), [recherche confrontée](../research/mining-reference.md), [preuves V27 archivées](../history/validation-v27-geology.md).

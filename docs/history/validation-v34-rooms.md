...
15 septembre 2026. [Contrat](../development/rooms.md), [recherche renouvelée](../research/rooms-reference.md). Schéma 34 inchangé ; G0 en consolidation, G1 partiel, première topologie d’habitat G2 livrée. Les preuves précédentes restent dans l’[audit CPU](../history/validation-v34-spatial-queries.md) et la [livraison des portes](../history/validation-v34-doors.md).

# Historique — validation V10 cuisine et consolidation

Preuves historiques conservées avec leurs conditions. Voir la [validation courante](../development/validation.md) pour les contrôles plus récents.

## V10 — Cuisine physique et combustible (14 septembre 2026)

[Règles revérifiées](../research/cooking-reference.md), [contrat et migration](../development/cooking.md). Cette tranche ne clôt ni G0 ni G1. Les lots ci-dessous se recouvrent : leurs nombres ne doivent pas être additionnés comme une couverture indépendante.
...
- [Grande carte — extension V2 et comparaisons CPU/communication/GPU](map-scale-v2.md)
- [Premières inspections graphiques G0](render-validation-g0.md)
- [V9 — alimentation et reclassement](validation-v9-alimentation.md)
- [V8 — cultures](validation-v8-cultures.md)
- [V6–V7 — présentation](validation-v6-v7-presentation.md)
- [V3–V5 — besoins](validation-v3-v5-besoins.md)
- [Fondations G0](validation-g0-fondations.md)

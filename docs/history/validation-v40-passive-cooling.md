...
15 septembre 2026. Refroidisseur passif, combustible partagé, contrôle du premier geste GPU. [Contrat](../development/passive-cooling.md), [recherche](../research/passive-cooling-reference.md). Les preuves V39 sont conservées dans [l’archive plantes/présentation](../history/validation-v39-plants-playability.md).

# Validation historique — températures et conservation V38

15 septembre 2026. [Contrat thermique](../development/temperature.md), [sources et adaptations](../research/temperature-reference.md), [inventaire fonctionnel](../gameplay/implementation-status.md). Les [preuves V37](../history/validation-v37-light-work.md) et l’[audit graphique V36](../history/validation-v36-environment-lighting.md) restent datés ; aucun nouveau shader ou pipeline dans ce lot.

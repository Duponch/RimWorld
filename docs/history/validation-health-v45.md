...
16–17 septembre 2026. [Santé active](../development/health.md), [références recontrôlées](../research/health-reference.md). Les preuves antérieures du noyau médical isolé et des interruptions de fatigue sont [archivées](../history/validation-health-preparation-v44.md).

...
**Adopter** cette interaction pour nos piles matérielles. **Adapter** la recherche à notre grille déterministe et à son budget partagé ; aucune région du moteur original n’est nécessaire. Le cultivateur réserve une quantité et une capacité, marche, porte et dépose avant le semis. Les petits rochers décoratifs restent sans objet transportable : les fragments minés et leur catalogue sont toujours absents. Le dégagement des chantiers reste à traiter.

...
**Livrer en deux tranches** occupation puis circulation : V21 corrige la coexistence et les zones ; le prochain lot doit rendre la table franchissable avec coût, exclusions d’arrêt et présentation GPU du passage. Son blocage actuel reste un écart explicite, qui n’empêche pas d’accéder aux piles par les cellules adjacentes. Les autres délais du mobilier sont également à calibrer. Cette séparation réduit la portée d’une migration sans déclarer le profil complet.

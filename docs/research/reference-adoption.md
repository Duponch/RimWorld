...
V85 — **réseau, solaire et stockage livrés et validés dans leur périmètre** : chapitres 10 et 22, SYS/TEST-127 et SYS/TEST-128, CAT-047. **Adopter** livraisons et emprises physiques, réseau cardinal, rétention des parents, intention distincte de l’interrupteur réel, charge/décharge et recherches ; **adapter** unités entières, deux ticks locaux pour le geste de 15 Core, refus conservatif de remplacer un conduit par un transmetteur, jour du site fixe ; **différer** Flick mobilisé, Reconnect, conduits cachés/étanches, éolien/météo, pannes et incendies. [Réseau et divergences](power-grid-reference.md), [batteries et recherches](power-battery-reference.md), [solaire et limites du site](solar-power-reference.md), [contrat](../development/power.md). Les Defs/classes Core **1.6.4871 rev590** ont été lues avant implémentation et confrontées aux sources publiques fraîches ; le miroir ancien et la source Odyssey de SYS-128 ne certifient pas le Core actuel. Les [preuves V85](../history/validation-energy-v85.md) distinguent les contrats, le natif contrôlé, la reprise de la colonie V84 jusqu’à J42,21 et les mesures synthétiques ENERGY ; les limites de débit et les échecs conservés ne sont pas assimilés à une parité exhaustive.

V84 — **filière alimentaire livrée et validée dans son périmètre** : chapitres 10–12, 14/15 et 22 ; SYS/TEST-056, 062..064, 070..072, 075, 077, 089, 091, 094, 096, 121..128 et UI-025. **Adopter** produits distincts, croissance favorable, factures et services physiques, coûts/chaleur/combustible des postes et condition de malnutrition séparée de la jauge ; **adapter** unités, présentation 3D, réseau local et variation médicale déterministe propre ; **différer** hygiène/intoxication, autres recettes, élevage et climat complet. [Cultures et versions](food-crops-reference.md), [postes](food-workstations-reference.md), [malnutrition et divergences](malnutrition-reference.md). La lecture locale Core 1.6.4871 et les recoupements publics précèdent le code ; aucun état du corpus ne prouve un résultat de test local. Les [preuves V84](../history/validation-food-v84.md) réunissent 91 contrôles, un parcours naturel de 24 jours avec deux cycles de riz, les cliniques de malnutrition, l’UI et les mesures successives. Pommes de terre récoltées/cuisinées et maïs encore immature restent distingués ; aucune autonomie universelle ni progression moyenne n’est déduite de ce parcours.

Les [87 états de progression historiques](colony-progression-observed.md), chapitres 11/12 complétés par 13/24, distinguent champs désignés, semis autorisés, plants présents, bâtiments, factures, points de recherche et stocks portés. Deux retours temporels imposent trois segments. **Adopter** ces distinctions d’observation ; **différer** toute moyenne d’un joueur, date précise de construction ou cadence Cassandra tirée de ce tutoriel Phoebe/Easy 1.6.4633. Les 80 cases de riz à J5 sont un repère du pilote, pas un rendement garanti.

V83 — site/sols : chapitres6/7,11/12,13,24 ; SYS/TEST-016..019,062..064,070..072,075,121..125,132..135. Adopter seuils/coûts/fertilités et budget commun des filons vérifiés dans Core1.6.4871 ; adapter bruit, PRNG, projection de végétation limitée et feuillus 3D ; différer globe/biomes/plantes/ruines absents. [Carte](map-calibration-reference.md), [sols/croissance](site-soils-reference.md). Aucun objectif de tout observer en sept jours.

Revue de partie du 20 septembre — chapitres 3, 5–7, 13 et 24 relus directement dans le HTML, complétés par les références des domaines 8/9, 11–15, 23 et 32 : SYS/TEST-016..019, 062..064, 070..072, 076..085, 121..125, 132..135. **Adopter** les défauts/conditions relevés dans l'installation Core 1.6.4871 et distinguer choix utilisateur, génération aléatoire et observation ; **adapter** seulement les algorithmes internes/3D en conservant les effets ; **vérifier** distributions sur plusieurs cartes contemporaines ; **différer** toute annonce de parité globale. [Base et écarts](core-reference-baseline.md), [contrat cible des menus](../development/new-game-menus.md). Le profil Récit d'aventure est choisi par l'utilisateur, pas un défaut inventé. Le corpus n'impose aucun calendrier « tout en sept jours ».
...
| Temps, faim et statistiques ; chap. 3/4/14, CONST-001..009 | **Vérifier puis adapter** les unités et cadences. Ne pas appliquer une variation par tick sans conversion de durée. | Avant calibration G1 : décider temps logique, journée et nutrition ; documenter conversions/migration. V82 a établi six ticks locaux/s, 6 000 ticks/jour et une journée nominale de 16 min 40 s ; le rapport de dix ticks Core par tick local reste distinct. V84 sépare aussi nourriture et condition médicale, avec conséquences et récupération éprouvées. |
...
| Réseau, carburant et réserve ; chap. 10/22, SYS/TEST-127/128, CAT-047 | **Adopter** les états et flux physiques, **adapter** l’arithmétique et les couches, **différer** les risques sans système causal. | V85 livrée et validée : conduits/interrupteurs, stockage orientable et transportable, solaire et recherches. Pas de geste mobilisé, d’éolien, météo complète, pannes générales ou feu ; G2 reste ouvert. [Décisions sourcées](power-grid-reference.md). |

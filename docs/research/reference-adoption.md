...
| Priorités et contexte ; chap. 8/9, UI-027, CONST-042..045 | **Adapter** vers 0 désactivé et 1..4 actives, avec départage stable et refus expliqués. L'ordre forcé respecte les contraintes matérielles. | À intégrer au chantier Travail G0 avec migration. Le jeu utilise encore 0..3. Arbitrer clic droit contextuel et glissement de caméra avant d'ajouter les ordres contextuels. |

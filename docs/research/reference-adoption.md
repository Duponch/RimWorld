...
Habillement en préparation sous V62 — chapitres 2/8/13/20/29 relus directement, SYS/TEST-055, UI-014/015, CAT-034..037 et GAP-007 : adopter couverture anatomique et couches dans un [noyau isolé](../development/armor.md). Corriger la comparaison trop simple des noms de groupes : des groupes distincts peuvent se recouvrir sur une partie réelle. [Recherche fraîche](apparel-reference.md). Transfert physique, contenu, armure intégrée et portraits habillés restent à livrer ; aucun statut du corpus ni GAP-007 déclaré clos.

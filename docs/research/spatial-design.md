...
La caméra conserve un cadrage local indépendant de l'étendue du territoire : agrandir la carte allonge les déplacements et augmente les possibilités d'implantation, sans rapetisser les personnages. La résolution de grille, les modèles et la densité de génération ne sont pas réduits pour compenser. Mesures et conditions de comparaison : [passage aux grandes cartes](../history/map-scale-v2.md). Combat et réaction aux menaces restent à valider lorsqu'ils existeront.

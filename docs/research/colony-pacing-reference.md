...
## Correction rétroactive de validation V86

La continuation naturelle a révélé une borne de sauvegarde erronée héritée de V82–V85 : 10,6 jours séparent les débuts de fenêtres Cassandra, pas nécessairement deux occasions. Une occasion précoce puis une occasion tardive du cycle suivant peuvent être plus éloignées. À J65,5657, la date 458 800 du cycle 6 est valide mais était refusée. Le validateur vérifie désormais la fenêtre exacte de l’agenda, le futur, les intervalles quantifiés, l’espacement et la correspondance stricte de `nextCheck` à sa première date ; le plafond de huit jours du calendrier de camp demeure. Dates, tirages et sélection d’incidents sont inchangés. Contrôle rouge avant correction, puis frontières réussies, restauration et continuation de 120 ticks byte-identiques. [Preuves](../../artifacts/prison-calendar-correction-v86.json). Il s’agit d’une correction de validation, pas d’une nouvelle calibration ou d’une migration d’agenda.

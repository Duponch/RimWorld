...
Dernières boucles livrées : [alimentation durable V84](development/food-workstations.md) et [habitat et énergie V85](development/power.md). La [captivité V86](development/prisoners.md) est livrée dans son périmètre. Arbre de recherche, médecine complète, commerce, saisons et environnement restent ouverts. [Inventaire consolidé](gameplay/implementation-status.md).
...
Préparations parallèles du prochain ensemble, **sans nouvelle mécanique livrée** : [saisons et survie végétale](research/seasons-crops-bundle-reference.md), [incendies et extinction](research/fire-bundle-reference.md), [vent, énergie et chauffage](research/wind-energy-bundle-reference.md). Les décisions ouvertes et adaptations de migration y restent explicites ; ROADMAP seule fixe la suite.

...
V76 ouvre S18 par une première faune autonome : lièvres, repas/broutage et sommeil, liste Faune, données animales séparées et rig GPU. Chasse, santé/mortalité, dépouilles/boucherie et élevage restent absents. Ce sous-ensemble ne clôt aucun jalon G0–G5. [Contrat](../development/wildlife.md), [état détaillé](implementation-status.md).
...
| S18 | Animaux et élevage — faune initiale V76, autres boucles absentes | P2 / G3 | S02, S07, S09, S13 | La faune vit, consomme et apporte des choix d'élevage ou de chasse. | Enclos ouvert, régime incompatible, croissance du troupeau, prédateur, famine, animaux malades. | Espèces de départ, entraînement et budget maximal de population. |

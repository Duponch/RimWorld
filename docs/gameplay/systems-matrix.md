...
**V83 :** S02/S09 progressent ensemble : site local à trois reliefs, sols de fertilités distinctes, géologie et ressources physiques, première récolte cuisinée et sauvegardes anciennes préservées. Douze jours naturels et parcours natif validés ; pas d'autonomie alimentaire ni de biome complet annoncés. Aucun jalon G0–G5 clos. Les prochains ensembles élémentaires sont programmés uniquement dans [ROADMAP](../ROADMAP.md) ; [preuves V83](../history/validation-site-v83.md).

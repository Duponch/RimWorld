...
Atterrissage forcé révision 4 conserve les 800 argent, le fusil et le couteau introduits en révision 3 et connaît désormais Taille de pierre à la création. Forge reste à rechercher. Trois survivants et les colonies déjà sauvegardées conservent leur ancienne dotation et leurs connaissances réelles. Les notes V80/V82 ci-dessous décrivent les versions historiques.
...
| Objet `silver` | **V88 validée dans son périmètre** : monnaie physique, pile 500, inventaire étranger ou sol/réserve, paiement et solde atomiques ; 800 au nouveau départ depuis la révision 3, conservés en révision 4. Nouvelles réserves proposées à 500 ; capacités historiques, notamment 75, et filtres conservés. | Extraction, matériau de construction et banque absents. La pile n’a pas de PV ni d’inflammabilité. Un filtre Argent absent refuse son rangement. |
...
| Structures `wall`, `bed`, `table`, `stool` | Mur, lit, table 1×2, tabouret, construits en bois ou acier V30 et cinq pierres V33 ; les trois meubles sont réinstallables en V25. | Aucun ensemble complet de mobilier ; autres matériaux et qualité absents ; dégâts/réparation V87 validés dans leur périmètre. Le lit en pierre a un repos ×0,9, les ouvrages un travail spécifique. |
| Terrains `grass`, `soil`, `rich-soil`, `gravel`, `water`, `rock` | Terre ordinaire 100 %, ancienne terre pauvre 70 %, terre riche 140 %, gravier 70 %, eau et massif. V83 relie semis/croissance/inspection/propreté et marche aux terrains. | Eau toujours infranchissable ; mares, boue et diversité des biomes absentes. Les sept sols construits V89 sont une couche distincte qui conserve le terrain dessous. Les anciennes cartes restent conservées. |

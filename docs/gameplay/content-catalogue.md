...
| Structure `battery` | **V85** : 70 acier + 2 composants, 1×2 orientable, 80 ticks neutres ; vide à l’achèvement, 600 Wd, rendement entrant 50 %, fuite 5 Wd/jour ; transport entier avec charge conservée. | Pas d’interrupteur propre, de variante avancée, d’explosion ni de court-circuit. Fuite maintenue emballée ; la destruction ne restitue pas l’énergie. |
| Structure `solar-generator` | **V85** : 100 acier + 3 composants, 4×4, 250 ticks neutres, Construction 6 ; potentiel 0–1 700 W lié à la lumière naturelle et aux cases non couvertes. | Fixe, jour du site actuel ; latitude, météo/saisons et ombres du décor ne constituent pas une simulation complète de production Core. |

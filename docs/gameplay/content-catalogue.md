...
Atterrissage forcé révision 3 reçoit les 800 argent, le fusil et le couteau au nouveau départ. Trois survivants et les colonies déjà sauvegardées conservent leur ancienne dotation. Les notes V80/V82 ci-dessous décrivent les versions historiques.
...
| Objet et plante `rice` | Riz semé/récolté ; croissance, fertilité, lumière et température locale ; 6 unités mûres, pile de 75, nutrition 0,05, malus de repas cru. | Pourrit en 40 jours à taux plein. Santé végétale/compétence Plantes complète et intoxication absentes. V84 étend le choix riz/coton avec deux cultures livrées. |
| Objet `simple-meal` | Repas simple au feu ; dix unités de baies/riz/viande admises, nutrition 0,9, pile de dix. V84 ajoute les cuisinières et ingrédients pomme de terre/maïs, seuls ou mélangés. | Pourrit en quatre jours à taux plein. Autres recettes, lots et intoxication absents ; filtres des factures anciennes conservés. |
...
| Objet `silver` | **V88 validée dans son périmètre** : monnaie physique, pile 500, inventaire étranger ou sol/réserve, paiement et solde atomiques ; 800 au nouveau départ révision 3. Nouvelles réserves proposées à 500 ; capacités historiques, notamment 75, et filtres conservés. | Extraction, matériau de construction et banque absents. La pile n’a pas de PV ni d’inflammabilité. Un filtre Argent absent refuse son rangement. |
...
| Structure `fueled-stove` | **V84** : 3×1, 80 acier, vide à l’achèvement, réserve de 50 bois ; préparation au combustible, factures/rotation/transport entier. | Bois consommé pendant le travail seulement ; pas de lumière propre, pas de recette avancée ni d’hygiène. |
...
| Structure `butcher-table` | **V84** : table en bois 3×1, 95 bois, service physique, rendement du poste 1 contre 0,7 au sol ; facture de dépouille existante. | Lésions/Cuisine/arrondis modulent le rendement ; autres matériaux, nettoyage et usage artisanal du cuir absents. |

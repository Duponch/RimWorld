...
**V112 — gestes et armes visibles :** faites tourner un colon ou un animal en lui faisant prendre un angle, y compris un demi-tour ; l'orientation du modèle pivote rapidement pendant que le chemin conserve ses cases habituelles. Désignez une roche à miner, un arbre à couper, un mur à construire ou une facture d'atelier : les bras ont quatre gestes simples différents. Aucune pioche ou hache n'est à fabriquer pour ces travaux. Équipez physiquement un fusil, puis observez-le sur le personnage et son avatar HUD/Bio ; mobilisez le colon et ordonnez un tir pour voir la pose de visée, le projectile existant et le bref recul. Les armes dans les avatars sont un choix de Lisière, contrairement au portrait Core. [Portée exacte et limites](../development/action-presentation.md).
...
Une réussite fait apparaître le lièvre dans **Animaux** plutôt que **Faune** ; sa fiche indique **domestique libre** et une familiarité sur cinq niveaux. Il continue à circuler et à manger physiquement. Chaque 45 000 ticks, il perd un niveau ; le travail Animaux entretient sa familiarité avec deux nouveaux aliments réels. À zéro, il redevient sauvage. Une chasse engagée sur lui s'arrête dès l'apprivoisement.

Dans **Santé**, choisissez la politique de soins du lièvre possédé (herbes médicinales par défaut) et activez **Médecin** chez un colon. Plaies et infections sont soignées au contact avec les médicaments réellement disponibles, si l'animal est couché ou incapable. Un lièvre blessé peut se reposer pour cette visite, mais se relève pour chercher de la nourriture sous 45 % de nutrition et réagit aux dangers. Aucune aire ni enclos, reproduction, lait ou laine n'est disponible. Le nouveau départ ne donne pas d'animal ; les anciennes colonies n'en reçoivent pas. [Contrat et limites](../development/domestic-animals.md).

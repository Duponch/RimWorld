...
La cuisinière à bois est **vide après construction**. Laissez Cuisine ou Transport apporter le bois ; sa réserve peut contenir 50 unités. Elle ne brûle ce combustible que pendant la préparation, et peut être rechargée sans affecter le cuisinier à Transport. La cuisinière électrique demande **350 W tant qu’elle est alimentée**, même au repos. Un générateur proche fournit le réseau local actuel ; câbles et batteries restent absents. Une panne de bois ou de courant bloque la préparation sans effacer les ingrédients. Ces postes chauffent leur pièce mais ne constituent pas une lampe : l’éclairage réel de la place du cuisinier compte.

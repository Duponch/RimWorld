...
Atelier de taille avec ingrédients fixes et matériau substituable livré en [V31](stonecutter.md). Prochaine dépendance : métier/recettes et blocs typés. Agréger les exigences identiques avant réservation, enrichir les mêmes scénarios, vérifier les règles et préserver les propriétés de la pierre avant ses variantes de mobilier.

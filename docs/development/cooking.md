...
Une facture de repas simple choisit dix unités parmi les baies, riz, viande de lièvre, pommes de terre et maïs admis, réserve les sources et les cases de dépôt, puis les rassemble par portages réels. Les [cuisinières V84](food-workstations.md) utilisent cette même chaîne, avec leur service orienté, leur surface de dépôt et leur énergie réelle. Chaque case conserve une seule pile compatible. Le colon rejoint exactement la place orientée du poste. Les ingrédients déposés restent des piles au sol réservées ; ils ne sont ni consommés à la prise ni cachés dans un inventaire d’atelier abstrait.
...
V23 maintient la priorité du poste après l’ordre manuel : recharge préalable puis factures réalisables, sous délai/annulation et contraintes de réservation ; [contrat partagé](player-orders.md). Une réservation de recette ne garantit pas les recettes suivantes.

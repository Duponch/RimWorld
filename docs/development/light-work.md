...
Les coûts de recherche restent neutres et les routes sont revérifiées physiquement. Leur coût n'est pas une ETA lumineuse. La vitesse de base locale reste provisoire (3 ticks par case) ; compétences, santé, météo et urgences de locomotion restent absentes. Les durées agricoles ne reproduisent pas encore tous les facteurs de croissance du consommateur Core relevés dans la recherche.

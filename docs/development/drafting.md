...
Tir dirigé et couvert utilisés en [V56](shooting.md). La rencontre V58 ajoute adversaire et fuite civile ; mêlée, formation par glisser, orientation d’attente imposée, feu à volonté et personnalité restent absents. Ordres d’équipement/soins civils pendant mobilisation encore refusés explicitement ; démobiliser permet ces actions. La boucle tactique est donc partielle, même si son déplacement est physique et persistant. Les modules `drafting-rules`, `drafting-destinations`, `drafting`, `drafting-save` séparent données, choix spatial, exécution et validation ; le tir V56 réutilise ces frontières et conserve sa récupération après annulation de l’ordre.

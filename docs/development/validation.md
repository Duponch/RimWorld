...
15 septembre 2026. [Contrat](light-work.md), [sources et décisions](../research/light-work-reference.md), [état fonctionnel](../gameplay/implementation-status.md). Les [preuves de présentation lumineuse V36](../history/validation-v36-environment-lighting.md) restent datées ; leur audit graphique n'est pas présenté comme rejoué sous V37.

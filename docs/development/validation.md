...
14 septembre 2026. G0 en consolidation, G1 partiel. [Contrat](deconstruction.md), [recherche et adaptations](../research/deconstruction-reference.md). Les [preuves V23](../history/validation-v23-priority.md) restent historiques, notamment leur charge mixte à cent colons.

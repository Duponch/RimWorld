# Validation courante — V88

**V88 validée dans son périmètre : visites, échanges et contenu utile.** [Visiteurs](visitors.md), [contact et panier atomique](trade.md), monnaie physique, fusil à verrou et couteau en plastacier sont intégrés. La vraie colonie V87 poursuit **816 438→956 959 ticks, J136,073→J159,493**, soit **23,420 jours par reprises documentées**, avec quatre habitants vivants et 192 repas produits. Trois passants puis deux visiteurs parcourent la carte et les cinq repartent. À 954 900 ticks, cinq revolvers de surplus sont échangés contre trois médicaments et six argent ; le marchand part à 956 925, puis le rangement physique des doses se termine à 956 959, soit 34 ticks plus tard. Aucun visiteur, stock ou argent injecté pour obtenir cette issue. La [preuve V88](../history/validation-trade-v88.md) conserve les conditions, diagnostics et reprises ; cette partie ne constitue ni une date garantie de visite ni une validation de toute l'économie Core.

La campagne centrale compte **82 contrôles distincts dans 21 fichiers**. Le parcours natif de commerce corrigé est repassé ; build et typage finaux passent. Les [mesures V88](../research/performance-v88.md) distinguent comparatifs purs à état final identique et charge enrichie : gains CPU de **7,6 à 15 % selon la charge comparée**, sans les attribuer à l'ensemble du lot. Avec **100 colons, 100 lièvres et 2 visiteurs**, le CPU p95 atteint **89,44 ms**, l'image p95 **41,6 ms** avec un pic **120,9 ms**, et le débit natif **2,640× pour 6× demandé**. Les sources et protocoles bornent ces résultats, sans garantie de fluidité parfaite. [Références économiques](../research/trade-reference-v88.md), [profils d'armes et adaptations](../research/weapons-v88.md). Diplomatie, autres familles commerciales, monde, catalogue intégral et fin de partie restent absents ou partiels ; aucun jalon global G0–G5 n'est clôturé par ce lot.

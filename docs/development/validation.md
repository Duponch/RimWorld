# Validation courante — V31, atelier de taille à ingrédients mixtes

15 septembre 2026. G0 en consolidation, G1 partiel ; chaîne pierre G2 en cours. [Contrat](stonecutter.md), [recherche](../research/stonecutter-reference.md), [preuves V30 archivées](../history/validation-v30-materials.md).

...
Le catalogue ajoute table en bois 1×2 et tabouret en bois 1×1. Leurs 28 et 25 bois doivent être livrés physiquement avant leurs 53 et 32 ticks de construction. Les emprises servent au placement, à l'accès de chantier, à l'inspection et à la navigation. Q/E tourne la table ; l'orientation d'un tabouret n'est pas un filtre de repas. La table achevée bloque encore le déplacement : écart temporaire, à corriger avec les profils de franchissement et leur présentation 3D. V21 permet des piles sur son plateau et une réserve sur un tabouret, sans multiplier les propriétaires ni les places de service. Depuis [V16](construction.md), plans et cadres se traversent ; une place de repas déjà réservée empêche la livraison/finition d'un chantier qui la recouvre.
...
En V6, les recherches pondérées de repas finalisent tous les buts de coût égal au meilleur but atteint. La carte des parents peut ensuite être partielle ; son usage reste limité au choix du plus proche aliment ou au siège prioritaire. Un siège inaccessible entraîne une exploration complète de la composante. Les décisions comparent des coûts, et non le nombre d’arêtes ; le [contrat spatial](spatial-motion-storage.md) précise diagonales et durée réelle. Navigation CPU, laboratoire GPU séparé.

...
- `BoxBatches.ts` partage géométrie et matériaux pour mobilier, plans, progression, réserves et piles. Chaque lot conserve ses matrices/couleurs GPU, même lorsqu'il devient vide. La capacité commence à 256 et double au besoin ; ce nombre est une allocation, pas une promesse de performance. Le nombre réellement dessiné correspond au contenu. Une croissance de capacité libère explicitement l'ancienne allocation, sans créer un nouveau matériau.

# Plantes 3D instanciées et paysage — V116/V117

V117 remplace les deux grandes taches quasi circulaires du pigment des falaises par un champ minéral déterministe à plusieurs échelles, déformé et jointif. Le motif de pierre partagé est calculé une fois à 256² ; sa répétition couvre environ 38 cases au lieu de multiplier de petites marques sur chaque case. La surface rocheuse garde ses sommets, attributs, matériau et un seul prélèvement de texture par fragment. L'option « Textures 3D stylisées » conserve son chemin sans échantillonnage quand elle est désactivée. Ce changement est visuel et ne modifie pas l'extraction ni les ressources physiques. [Images et contrôles V117](../history/validation-action-contact-v117.md).

...
V58 ajoute deux affiliations fixes, une sentinelle qui tire, la fuite civile et les collisions hostiles. Mêlée V59 livrée ; armure, objets endommagés et dépouille transportable restent absents. Le [ralentissement temporaire du pouvoir d’arrêt](stagger.md) est ajouté en V57. Jauge graphique de visée/récupération, son et effets d’impact restent absents. La sentinelle reste statique ; [tir automatique des colons et Attaquer civil](automatic-combat.md) livrés V60. Portraits encore schématiques, vêtements et inventaire personnel absents.

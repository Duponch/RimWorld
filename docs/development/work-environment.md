...
Cette tranche branche les **recettes** présentes. La pénalité lumineuse des autres métiers et des déplacements, effets psychologiques, capacités/compétences, température, propreté, confort et richesse restent à développer. La croissance naturelle conserve son intégrale et son arrêt sous toit ; les feux ne franchissent pas son seuil. Mort des plantes dans l’obscurité et autres espèces restent absentes.

L’inspection affiche lumière de la cellule, rôle et facteurs de production à la place orientée du poste. Le rendu 3D conserve son ciel stylisé et les flammes existantes : le halo réel des feux sur le décor et l’éclairage des intérieurs en coupe sont encore absents. Aucun `PointLight` par feu ni coût graphique nouveau n’est revendiqué. Les rôles livrés ne donnent aucun bonus de chambre, de salle à manger ou d’humeur.

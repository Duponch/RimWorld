...
V84 ajoute la [malnutrition](malnutrition.md), commune aux humains et lièvres : faim persistante, conscience diminuée, incapacité ou décès, récupération progressive après ingestion. Elle ne constitue ni une plaie à panser ni un traitement médicamenteux. V81 ajoute les [infections de plaies et l’immunité](infections.md), communes aux humains et aux lièvres : risque porté par les nouvelles lésions, maladie localisée, soins renouvelés, récupération ou décès. Les soins vétérinaires restent absents. Le contrat distingue la fermeture d’une plaie, la disparition de l’infection et le développement de l’immunité ; aucune de ces étapes ne remplace les deux autres.

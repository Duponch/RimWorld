...
La fonctionnalité passe ses contrôles métier/UI ; la garde générale de présentation demeure rouge sur trois micro-attentes d’abattage, sans retrait anticipé. Ce point précède la mobilisation dans ROADMAP et n’est pas présenté comme résolu par l’équipement.

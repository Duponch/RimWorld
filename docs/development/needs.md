# Repas et couchages physiques — schéma 3
...
Tables/sièges, pensées de repas, cuisine, types d'aliments, pourrissement, horaires, malnutrition et maladies restent **absents**. Cette tranche livre les actions physiques actuelles ; elle ne clôt pas tout le domaine survie.

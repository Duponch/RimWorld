...
L’humeur actuelle est une valeur sauvegardée qui converge vers une cible dérivée des pensées. Le joueur consulte les causes, leurs valeurs et l’échéance des souvenirs dans **Pensées et humeur**, dans l’inspection du colon. Ce lot remplace la moyenne instantanée faim/repos, sans annoncer crises mentales ou relations. [Sources et écarts](../research/mood-reference.md), [preuves](../history/validation-mood-v64.md).

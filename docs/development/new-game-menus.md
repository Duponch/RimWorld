...
V98 étend **Charger** avec une [bibliothèque de six colonies de test](test-colonies.md), téléchargement et import JSON. Le même écran est accessible depuis Menu sans sauvegarde implicite. Ouverture en pause, exclusion et validation stricte communes ; sauvegarde manuelle intacte, partie active préservée dans Colonie précédente. Les menus de création restent inchangés.

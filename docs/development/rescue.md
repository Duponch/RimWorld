...
- Les acteurs actuels sont des colons adultes alliés. Contrôle d'ennemi proche, permission de faction, prisonnier, animal et dangers tactiques restent à brancher sur ces futurs systèmes. V74 ajoute les canicules et le secours vers un lit refroidi. Le filtre général de danger thermique et le classement correspondant restent partiels : désigner un lit médical dans le refuge, plutôt que compter sur le lit pour guérir la chaleur. Aucun transfert spontané entre lits chauds/froids ; [confrontation et limites](../research/heatwave-reference.md).

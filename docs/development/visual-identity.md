...
**V114 — volumes peints :** murs en bois à large planche verticale, porte en acier sous linteau en bois et toit en dalle continue sur intérieur et supports voisins. Des textures originales à larges plages de pigment, au grain secondaire, couvrent aussi les objets construits, ressources et arbres, cultures et plantes, humains et animaux pris en charge par les lots 3D. Le réglage « Textures 3D stylisées », dans l'accueil et le menu du jeu, est conservé localement dans le navigateur ; sa désactivation choisit les matériaux unis résidents sans échantillonner ces textures. Ce choix ne modifie ni sauvegarde ni règle du jeu. [Contrat](timber-buildings.md), [validation en cours](../history/validation-timber-v114.md).

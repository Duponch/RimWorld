...
La présentation V35 plaçait une dalle de 12 cm au-dessus des murs suivant `WORLD_SCALE`. En V114, [la dalle visible](timber-buildings.md) est un maillage résident unique : sa surface haute continue couvre les cellules construites ainsi que les murs, portes et angles voisins, sans ressaut intérieur ; seule sa bordure extérieure retombe sur 0,31 unité et déborde légèrement. Elle se reconstruit lors d'un changement de couverture, de ces structures ou de coupe, pas à chaque image. Le bouton permanent affiche/masque les toits sans effet sur World. Le masquage retire le toit de la carte d’ombres, mais le [champ d’éclairage intérieur](environment-lighting.md) conserve l’obscurité et les feux sous la couverture logique. Aucun étage jouable n'est ajouté.

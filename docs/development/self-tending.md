...
Dans Médecin, le traitement des autres humains couchés précède les auto-soins, puis vient l'alimentation des patients. Les priorités numériques et Patient/Repos au lit restent distincts. Un ordre direct **Se soigner sans médicament**, au clic droit sur le colon sélectionné, engage la même action. Il peut terminer après désactivation du métier ; décocher l'option ou interdire les soins arrête aussi un ordre forcé, avant résultat. File médicale toujours refusée.

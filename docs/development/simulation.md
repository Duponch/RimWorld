...
Schéma courant **86**, validé dans son périmètre : [captivité, soins, approvisionnement et recrutement](prisoners.md). Les données de captivité et les tâches `ward` s'intègrent aux personnes, réservations et activités existantes. V85 est validée strictement avant migration additive de Geôlier 3 ; aucune personne, prison ou résistance n'est créée au chargement.

La correction de rythme V82 applique six ticks locaux par seconde, soit 16 min 40 s pour les 6 000 ticks d'une journée à 1×. L'heure civile initiale de 6 h du nouveau profil reste distincte du temps écoulé ; voir la [base de référence](../research/core-reference-baseline.md) et le contrat d'horloge ci-dessous.
...
Schéma historique **81** : [infection de plaie et immunité](infections.md). Validation stricte V80 avant migration neutre, sans exposition ni maladie ajoutée aux anciennes plaies. Les paragraphes versionnés suivants retracent les contrats historiques, pas un autre état courant.
...
V86 ajoute Geôlier au même tableau de priorités. La capture utilise le secours commun jusqu'au lit ; le statut de détenu n'apparaît qu'après l'arrivée et la prévalidation des dépôts. Les soins restent sous Médecin, tandis que Geôlier transporte et nourrit les captifs puis apporte leurs repas et converse. Une tâche `ward` partage l'exclusivité de personne, chevet, source, cargaison et destination avec les tâches existantes. Le prisonnier conserve santé et besoins sans être disponible pour le travail civil ou la mobilisation ; son recrutement conserve l'identité et les acquis. Les règles détaillées restent dans [Captivité et recrutement](prisoners.md).

...
Première tranche de l’étape 4. **Livré : culture → récolte → transport → stockage. Confection et recherche encore absentes.** [Sources fraîches et choix de filière](../research/textile-reference.md), [agriculture partagée](farming.md).
...
Absents : confection, ouvrages inachevés, compétence Artisanat/Plantes complète, qualité de fabrication, recherche, autres textiles/cuirs, PV/mortalité végétale, maladies, détérioration des piles exposées, climat saisonnier et coût de passage propre aux plants. Le profil de rendement demeure sain/neutre. La matière première obtenable ne signifie pas que la filière d’équipement est terminée.

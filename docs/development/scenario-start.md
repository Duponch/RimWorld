...
V91 : le nouveau Crashlanded révision 6 utilise un site révision 2, un milieu choisi et les populations biologiques correspondantes. Dotation et recherches initiales V90 sont conservées. Une sauvegarde V90 est validée strictement avant migration neutre vers V91 : aucune régénération de carte, espèce, dotation ni connaissance ajoutée.

# Nouvelle partie — Atterrissage forcé partiel V88 et profils historiques
...
**Atterrissage forcé**, identifiant `crashlanded` révision 3, conserve le `gameProfile` révision 1 : `cassandra-partial`, `adventure-story`, `reloadable`. La révision 1 des départs V82 et la révision 2 des départs V83–V87 restent historiques, sans complément de dotation au chargement. **Trois survivants** conserve l'identifiant `survivors`, sa provenance et ses règles historiques. Le **camp pédagogique** et la **sentinelle** restent des scénarios de diagnostic accessibles explicitement aux parcours qui en dépendent. Le nouveau menu ne les présente pas comme des variantes Core livrées. Un scénario ne se déduit jamais d'une sauvegarde historique ou de la présence d'objets.
...
Quantités totales par objet, pas par pile. Respecter limites de pile, compatibilité et une pile/cellule, sans effacer une ressource pour faire une place. Personnes, vêtements et piles ont des identités/propriétés cohérentes ; l'inventaire participe aux bilans habituels. Aucun lit, réserve, chantier ou repas consommé créé pour le joueur. Départ après arrivée, sans capsule ni cryptosommeil simulés. Argent, fusil et couteau sont propres au nouveau Crashlanded révision 3 ; Trois survivants et les anciennes révisions ne les reçoivent pas. Leur prix, équipement et usage suivent les [contrats de commerce](trade.md) et d'[armes](../research/weapons-v88.md).
...
Les deux projets acquis suivent ce sous-ensemble industriel Core. Batteries et Panneaux solaires, ajoutés en V85, restent à rechercher : l'acquisition initiale ne s'étend pas implicitement à chaque nouveau projet. Le camp pédagogique conserve son cycle complet. L'accès général à l'électricité reste partiel, conformément au [contrat de réseau](power.md).

...
[Refroidissement passif V40](passive-cooling.md) livré. Pas encore de chauffage électrique, climatiseur électrique, réseau électrique complet, saisons, autres météos, climat de site sélectionnable, toits naturels ou échange souterrain. Coup de chaleur, isolation et refuge civil sont actifs en [V74](heatwave.md). Froid corporel, pensées thermiques et sommeil lié à la température restent absents. La [croissance thermique et les semis V39](plant-temperature.md) utilisent cet air local. Mortalité au froid, feuilles et saisons doivent encore précéder les biomes froids. Les tests de gel emploient un historique froid synthétique, pas un congélateur déjà constructible.

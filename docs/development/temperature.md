...
Le site tempéré suit une moyenne provisoire de 21 °C, modulée de ±7 °C par le cycle quotidien Core : minimum vers 04:19, maximum vers 16:19. [V74](heatwave.md) ajoute l’offset persistant de canicule à ce cycle ; ce n’est pas encore un climat saisonnier. Une enceinte retient son air seulement si elle ne rejoint pas le bord et si moins de 25 % de ses cellules sont sans toit. Les seuils de production et de psychologie restent indépendants.
...
[Refroidissement passif V40](passive-cooling.md) livré. [Climatiseur V75](cold-store.md) livré. Pas encore de chauffage électrique, réseau électrique complet, saisons, autres météos, climat de site sélectionnable, toits naturels ou échange souterrain. Coup de chaleur, isolation et refuge civil sont actifs en [V74](heatwave.md). Hypothermie V75 active ; gelures localisées, pensées thermiques et choix complet du sommeil selon danger restent absents. La [croissance thermique et les semis V39](plant-temperature.md) utilisent cet air local. Mortalité au froid, feuilles et saisons doivent encore précéder les biomes froids. Les anciennes fixtures synthétiques restent des oracles ; V75 ajoute un parcours de construction/recherche/stockage effectivement obtenu.

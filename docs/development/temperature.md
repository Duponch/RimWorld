...
Pas encore de chauffage électrique, refroidisseur, refroidissement passif, réseau électrique, saisons, météo, climat de site sélectionnable, toits naturels ou échange souterrain. Santé thermique, confort, sommeil lié à la température et déplacement vers un lieu sûr restent absents. La croissance des plantes reste dans son profil tempéré ; l'intégration thermique agricole doit précéder tout contenu froid/chaud franchissant 6–42 °C. Les tests de gel emploient un historique froid synthétique, pas un congélateur déjà constructible.

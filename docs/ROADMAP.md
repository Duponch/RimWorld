...
- V17 : sélection multiple et file de travaux exécutables avec motifs de refus livrées. V18 complète transport et approvisionnement avec réservations quantitatives. Restent dégagement, combustible et cuisine forcés, autres familles sélectionnables et maintien local du travail priorisé ; [contrat](development/player-orders.md).

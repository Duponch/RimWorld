...
3. **Compléments de G1, puis habitat G2** : identités géologiques V27 livrées ; minage physique, sol découvert et produits livrés en V28 ; acier extractible/stockable livré en V29 ; prochains lots : recettes de construction à plusieurs matériaux, puis atelier de taille et blocs de pierre après les transferts et la logistique V25–V26 ; autres recettes, ateliers, statistiques utiles et catalogue progressivement enrichi. Portes/toits/pièces, températures variables et chaîne du froid restent ouverts. Le feu ne chauffe pas encore les pièces.

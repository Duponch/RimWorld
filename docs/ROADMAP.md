...
État : **20 septembre 2026, V82**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).

Dernière boucle : [création et reprise V82](development/new-game-menus.md), accueil réel, choix explicites, chargements courant/historique, journée corrigée et premier profil Cassandra/Récit d’aventure partiel. Huit jours joués avec défense du premier raid, sans autonomie alimentaire durable démontrée. [Preuves V82](history/validation-new-game-v82.md).
...
**Suite après cette livraison, à reprendre sur instruction en mode jour :** relier configuration locale et paysage à un contexte de site vérifié (relief, pierre, eau, végétation), avec distributions comparées aux règles locales et au témoin boréal sans le transformer en moyenne universelle. Poursuivre aussi l’observation jusqu’à la première récolte et vérifier ses facteurs : le riz atteint seulement 79,2–80,0 % après les huit jours du pilote V82. Compléter ensuite la dotation réellement jouable et l’introduction des catégories d’incidents ; budget de menace, richesse/adaptation et croissance de population restent à étudier/implémenter. Monde/site/personnes et leurs choix aléatoires restent une cible explicite ; pas de globe ou de candidats décoratifs.

...
| Validation | Rectangles, cartes 250² et boucle matérielle vérifiés | 15 scénarios (8 simulation, 3 génération, 2 contrats GPU, 1 codec, 1 désignation), dont 60 000 ticks avec conservation ; quatre parcours navigateur passent ensemble ; build et aperçu WebGPU AMD/RDNA-1 validés. Portée et limites dans validation.md, area-designations.md et map-scale.md. |
...
| Persistance | Schéma 2, migration V1, cargaison et chantier partiel restaurés, données invalides refusées. | Journal complet des commandes datées et de leurs résultats, manifestes, export/import et reprise d'évolution des règles. |

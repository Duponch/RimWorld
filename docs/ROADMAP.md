...
Incréments du lot : [requêtes de ligne/couvert/visée](development/combat-queries.md), [profils du revolver et précision](research/ranged-statistics-reference.md), puis [impacts V54](development/bullet-impact.md). Ces derniers ont leurs scénarios, migration stricte, clinique UI et mesure CPU à cent dossiers ; les impacts des fixtures sont injectés explicitement. La [capture du décor réel](development/combat-world.md) est testée : remplissages, portes, cadres, plantes et fragments, avec coût mesuré sur 250². Le [noyau d'émission/vol/interception](development/projectiles.md) est désormais testé séparément, dont cibles mobiles, reprise et coût de cent vols. Restent l'adaptateur réel de tous les candidats, le vrai producteur d'XP/Tir, les phases/vol sauvegardés, la commande et l'adversaire. Brancher ces dépendances en un parcours visible ; ne pas confondre le JSON de fixture avec la persistance du jeu. Ces sous-étapes ne sont pas des livraisons de combat jouable.

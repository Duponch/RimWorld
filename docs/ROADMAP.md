...
V39 complète la [croissance sous température locale](development/plant-temperature.md) et la suspension des nouveaux semis hors plage. Riz et buissons conservent leur passé thermique ; inspection, reprise et deltas sont reliés au même contrat. Les défauts visibles précédents ont fait l’objet d’un [retour d’expérience et de contrôles de livraison renforcés](development/playability-validation.md).

**Prochaine étape : refroidissement passif**, puis appareils et réseau de la chaîne du froid. Les températures des plantes sont désormais consommées ; mortalité et feuillage doivent précéder gel saisonnier et biomes froids. V38 conserve températures quotidiennes/locales, chauffage et conservation. G0 en consolidation, G1 partiel, G2 en cours ; aucun jalon déclaré complet.

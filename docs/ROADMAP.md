...
V61 — [approche ennemie et postes de tir](development/pursuit.md) : nouvelles rencontres mobiles, couvert et route physique, approche en mêlée, sauvegardes historiques préservées ; prolonge le tir automatique V60. Combat encore partiel ; aucun jalon G0–G5 déclaré clos.
...
**Prochaine livraison visée : réveils défensifs et réaction aux dommages.** Vérifier les branches Core de sommeil/repos médical, l’attaque reçue et les trois politiques civiles ; compléter la réaction physique sans effacer récupération, cargaison, arête ou réservations. V61 livre approche visible et postes de tir individuels dans les nouvelles rencontres. Le compagnon de colonie affecte un survivant aux secours si le médecin est lui-même blessé. Les sentinelles historiques restent fixes par migration neutre. Raids, recherche d’objectifs invisibles, stratégie/retraite de groupe, récupération d’arme et besoins autonomes NPC restent distincts. Puis poursuivre vêtements/armures et pensées/relations selon leurs dépendances, sans approfondir l’électricité. [Contrat V61](development/pursuit.md), [preuves et limites de charge](history/validation-pursuit-v61.md).

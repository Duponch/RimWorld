...
**Dernière livraison V86 : captivité et croissance de la colonie.** Capture physique, soins, nourriture, résistance et recrutement relient les raids à une quatrième personne, entretenue jusqu’à J76,28 dans la continuation réelle du camp. Les optimisations CPU réduisent des coûts mesurés sans changer les règles ; 6× reste non tenu à cent colons. [Contrat](development/prisoners.md), [preuves et limites V86](history/validation-prisoners-v86.md).
...
État : **20 septembre 2026, V86 validée et livrée**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).
...
**Prochain ensemble préparé en parallèle : [saisons/cultures](research/seasons-crops-bundle-reference.md), [incendies/extinction](research/fire-bundle-reference.md) et [vent/énergie](research/wind-energy-bundle-reference.md).** Le périmètre commun sera fixé depuis les recherches, autour des réserves, chauffage, vêtements et réseau. Ces trois axes sont préparés, pas implémentés. Ils partageront une campagne de colonie longue et des checkpoints contrôlés pour les événements rares ; pas un parcours complet répété par sous-système. Le commerce reste distinct : monnaie, panier, prix, inventaires et visiteurs demandent leur propre chaîne. L’éolien exige un vent partagé, l’extinction des dégâts et accès cohérents. Mode jour : V86 validée et publiée, sans reprise nocturne automatique.
...
| 1 — Habitat et énergie, boucle V85 livrée | Réseau construit, commutation physique, stockage et solaire reliés à cuisine/froid, jusqu'à J42,21 depuis le camp V84. Dégâts limités aux barrières ; entretien électrique général absent. | Coûts, énergie, coupures et reprises vérifiés. Éolien, incendie/extinction et pannes/réparations générales restent des boucles distinctes à cadrer avec météo et dégâts. |
...
| 3 — Environnement et survie, ensemble élargi en préparation | Croiser saisons/cultures, chauffage et réserves, incendies/extinction et vent/énergie dans une même colonie. | Références, provenance climatique, dégâts conservatifs et frontières attribuées avant code ; anciennes cartes/climats préservés. Parcours saisonnier naturel et checkpoints rares distincts, sans exiger tout avant J7. |
...
Revue du 20 septembre 2026 après V85 : domaine électrique réévalué, estimation globale conservée. Ces jugements portent sur des fonctions, jamais sur un pourcentage de temps restant.
...
| Électricité et combustible | 45 % (35–55) | Générateur à bois, conduits/interrupteurs construits, solaire, batteries, lampes, froid et cuisine ; nuit, coupures et reprise jouées | Éolien/autres producteurs, incidents et réparations, réseau intercartes, météo et catalogue complet |

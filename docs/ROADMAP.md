...
V37 étend les [effets de la lumière aux travaux et déplacements](development/light-work.md) : fractions de travail conservées, cadence minière et arêtes capturées, migration stricte et inspection. V36 conserve les facteurs des ateliers et [l'éclairage visible 3D](development/environment-lighting.md). **Prochaine étape : température extérieure/intérieure et conservation sous température variable**, avant la chaîne du froid équipée. G0 en consolidation, G1 partiel, G2 en cours ; aucun nouveau jalon déclaré complet.

...
État : 16 septembre 2026. **ROADMAP est l’unique calendrier G0–G5.** G0 en consolidation, G1 et G2 partiels ; G3 commence par ses fondations humaines. Aucun jalon complet. [Inventaire réel](gameplay/implementation-status.md), [validation](development/validation.md), [index](README.md).

## Priorité actuelle

Le camp possède matériaux, construction, nourriture, repos, loisirs, toits, température locale et première électricité. Il manque encore les conséquences humaines : capacités, blessures, soins et conflits. L’habitat a été approfondi trop longtemps avant ces boucles. L’ordre ci-dessous traverse les jalons selon leurs dépendances ; il ne faut pas finir chaque appareil de G2 avant de commencer G3.
...
2. **Corps, capacités et blessures** : interruptions de fatigue/cargaison sécurisées en [V44](development/interrupted-cargo.md) ; [socle anatomique](development/body.md) et [module de lésions, cicatrices, saignement et guérison](development/injuries.md) codés/testés, pas encore branchés à la partie ; anatomie adulte, parties vitales, douleur/saignement et état à terre, effets sur marche et travail, interruptions/réservations et sauvegarde. Premier producteur de blessures limité mais réel ; aucun remplacement par une vie globale générique. [Préparation et points de vigilance](research/health-preparation.md).
3. **Secours et soins** : transport du blessé, couchage, médecin, traitement physique, repos/guérison, alimentation du patient et premières conséquences. Puis maladies et complications à mesure que leurs producteurs arrivent.

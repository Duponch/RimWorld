...
État : **20 septembre 2026, après V81**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).

Dernière boucle : [infection de plaie V81](development/infections.md), progression et immunité consultables, soins physiques renouvelés, besoins et récupération persistés. [Preuves](history/validation-infections-v81.md). Autres maladies, chirurgie et soins vétérinaires restent absents.
...
**Mode jour, demandé le 20 septembre 2026.** L’utilisateur a réorienté le lot vers la fidélité du déroulement d’une partie : recherche du rythme, des réglages initiaux, de la carte et des ressources avant les modifications. Les parcours bornés à une semaine sont suspendus. Sous-agents indépendants avec intégration centrale ; automatisation nocturne suspendue.
...
**Profil décidé par l'utilisateur : Atterrissage forcé / Cassandra Classique / Récit d'aventure, Core.** Nouvelle partie et Charger actifs, Options seulement si fonctionnelles ; autres boutons, scénarios et difficultés visibles mais grisés. [Contrat cible des menus](development/new-game-menus.md). Récit d'aventure est un choix explicite, pas une difficulté présélectionnée dans RimWorld. Menus et profil ne sont pas encore livrés.

**Prochaine boucle : créer et reprendre une partie sous ce profil explicite.** Regrouper accueil/création/chargement, configuration persistante et premiers écarts certains qui conditionnent le départ. Traiter les dépendances par conséquences visibles : temps réel et début de journée, paysage/ressources disponibles, puis introduction et pression du narrateur. Un nom de scénario ne remplace pas sa dotation ; une radio de difficulté sans effets réels est refusée. Les limites de catalogue encore présentes doivent rester visibles et documentées, sans dérive vers tous les scénarios, biomes ou narrateurs avant cette boucle. Les anciennes parties gardent carte, stocks, provenance et continuation.
...
Revue du 20 septembre 2026, V81.
...
| Génération des sites, sols et biomes | 30 % (20–40) | Carte 250², scénario et dotation, spawn admissible, végétation/faune calibrées | Diversité des biomes, géographie/ressources, saisons locales, cartes spéciales |

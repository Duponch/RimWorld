...
**G0 est en consolidation, G1 partiel.** Le camp dispose de récolte, portage, stockage, constructions, repas et couchages physiques, tables et culture de riz. V10 a ajouté feu, combustible et factures ; V11 ajoute fraîcheur, pourriture et reprise des tâches affectées ; V12 ajoute horaires, fatigue adulte et réveils ; V13 ajoute les régimes alimentaires partagés, V14 corrige le passage entre colons civils en préservant les réservations. V15 ajoute observation du ciel, fers à cheval, satisfaction/lassitude et plages Loisirs. V16 distingue plans/cadres, permet leur traversée et dégage physiquement les piles/plantes avant construction. V17 ajoute sélection multiple, menu de travail individuel, ordres directs et files réservées pour travaux exécutables. Schéma 17 et migrations V1–V16. Cartes par défaut 250², rendu GPU, déplacements temporisés, ciel jour/nuit et deux projections sont livrés avec les limites de leurs contrats.

## Prochains lots

1. **Compléter les commandes de base G0** : sélection multiple et ordres directs sur travaux exécutables livrés en V17. Prochain lot : transport/approvisionnement forcés et leurs réservations de quantités, puis cuisine et autres fournisseurs contextuels ; ne pas transformer un sous-travail en promesse de terminer toute une chaîne. Les plans/cadres et dégagements sont livrés en V16 ; coexistence meuble/objet, réserves sous plans et personnes immobiles gênantes restent à compléter avec les profils d’occupation.
...
- V17 : sélection multiple et file de travaux exécutables avec motifs de refus livrées. Restent fournisseurs quantitatifs transport/approvisionnement/cuisine, autres familles sélectionnables et maintien local du travail priorisé ; [contrat](development/player-orders.md).

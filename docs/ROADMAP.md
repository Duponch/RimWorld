...
V58 — [première rencontre armée et fuite](development/encounters.md) : sentinelle de scénario utilisant le tir et la santé existants, affiliation, permissions de portes, collisions hostiles et réaction civile. Combat encore partiel ; aucun jalon G0–G5 déclaré clos.
...
**Mode jour rétabli le 18 septembre à la demande utilisateur.** La reprise automatique de nuit est suspendue ; terminer un lot cohérent, commit/push et bilan, puis attendre la prochaine instruction. V58 termine le lot de rencontre engagé ; aucune reprise nocturne implicite.

**Prochaine livraison visée : combat rapproché, puis poursuite et riposte cohérentes.** La sentinelle V58 donne une première menace jouable, mais reste statique. Prioriser la mêlée de base (outils naturels/arme, accès, cadence, toucher/esquive et dommages), puis tir automatique des mobilisés et réaction Attaquer, avant l’IA de poursuite/positions de tir. Cela ferme le trou actuel à une case, sans inventer des dégâts de proximité. Retraite et raids restent distincts. Réveils/interruptions civiles, récupération d’arme et besoins autonomes du NPC sont aussi explicitement ouverts. Continuer le parcours menace → blessure → secours/soins → retour au camp et la charge mixte ; ne pas confondre sentinelle et raid/narrateur. [Limites et sources V58](development/encounters.md).

...
V54 — [producteur d'impact anatomique Bullet et Gunshot](development/bullet-impact.md) intégré au module médical, sans déclencheur joueur. La mobilisation et les déplacements V53 restent la dernière nouvelle commande jouable. Prochain lot précis : premier tir dirigé et adversaire, avec compétence Tir active, préparation/récupération, émission/vol/impact persistants et réactions civiles. Ne pas ajouter une attaque instantanée générique. Aucun jalon G0–G5 déclaré clos.

Incréments du lot : [requêtes de ligne/couvert/visée](development/combat-queries.md), [profils du revolver et précision](research/ranged-statistics-reference.md), puis [impacts V54](development/bullet-impact.md). Ces derniers ont leurs scénarios, migration stricte, clinique UI et mesure CPU à cent dossiers ; les impacts des fixtures sont injectés explicitement. La [capture du décor réel](development/combat-world.md) est testée : remplissages, portes, cadres, plantes et fragments, avec coût mesuré sur 250². Le [noyau d'émission/vol/interception](development/projectiles.md) est désormais testé séparément, dont cibles mobiles, reprise et coût de cent vols. La capture des cibles réelles est ajoutée avec cinq scénarios de recouvrement, relations, secours et déplacement/impact ; son coût est mesuré et réduit. Restent le vrai producteur d'XP/Tir, les phases/vol sauvegardés, la commande et l'adversaire ; objets endommagés et dépouilles demandent encore leurs contrats. Brancher ces dépendances en un parcours visible ; ne pas confondre le JSON de fixture avec la persistance du jeu. Ces sous-étapes ne sont pas des livraisons de combat jouable.

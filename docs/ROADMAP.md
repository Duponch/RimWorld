...
**Mode jour, demandé le 20 septembre 2026.** La boucle médicale V81 est livrée ; attendre la prochaine instruction après le bilan. Sous-agents indépendants avec intégration centrale ; automatisation nocturne suspendue.
...
**Prochain lot proposé : première semaine du départ Trois survivants.** Relier les boucles disponibles depuis la vraie dotation sur plusieurs graines : nourriture renouvelable produite et ingérée, réserve, premier affrontement et reprise des travaux après les soins nécessaires. Corriger les blocages observés et préciser la calibration du départ. Ne pas imposer une infection sur chaque graine ni enlever des rations pour forcer le parcours ; ne pas étendre immédiatement le catalogue médical.

**Critère d'arrêt du prochain lot :** une semaine documentée sur plusieurs graines depuis le vrai départ, avec bilans de ressources, repas renouvelables et suites d’une menace réellement survenue ; restauration dans la vraie UI d’un camp obtenu. La survie seule ne certifie pas une difficulté équivalente à Core. Saisons, pluie/incendies, catalogue d'espèces, prisonniers, commerce et scénario mondial restent des boucles distinctes ; cette priorité ne clôt pas la santé. Dette froide : gelures, pensées et danger des lits.

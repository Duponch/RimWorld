...
**Dernière livraison V85 : habitat et énergie.** Conduits construits, interrupteurs au contact, batteries et solaire relient recherche, extraction, cuisine électrique et chambre froide. La reprise du vrai camp V84 de J24 atteint J42,21 avec trois colons vivants, onze repas électriques, aliments gelés, batterie nocturne et coupures suivies d'un raccord effectif. [Contrat et limites](development/power.md), [preuves V85](history/validation-energy-v85.md). Les [87 sauvegardes historiques](research/colony-progression-observed.md) servent de repères datés, pas de moyenne ni de calendrier à reproduire.
...
État : **20 septembre 2026, V85 validée et livrée**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).
...
**Prochain gros ensemble : croissance de la colonie et rencontres.** V85 satisfait sa boucle habitat/énergie ; poursuivre maintenant besoins d'une population accrue et une filière de rencontre complète, à choisir après recherche parmi commerce ou prise en charge/capture selon dépendances. Argent, statuts, nourriture, soins et réservations doivent avoir des effets réels ; ne pas substituer un écran de faction aux échanges ou à la captivité. Les saisons viennent ensuite. L'éolien attend un vent commun ; incendies et entretien général restent distincts, sans incident arbitraire pour les simuler. Mode jour : la prochaine exécution attend l'instruction utilisateur.

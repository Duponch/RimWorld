...
2. **Corps, capacités et blessures** : [socle anatomique et capacités codés/testés, pas encore branchés à la partie](development/body.md) ; anatomie adulte, parties vitales, douleur/saignement et état à terre, effets sur marche et travail, interruptions/réservations et sauvegarde. Premier producteur de blessures limité mais réel ; aucun remplacement par une vie globale générique. [Préparation et points de vigilance](research/health-preparation.md).

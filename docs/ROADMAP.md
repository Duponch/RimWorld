...
| Stockage | Cellules filtrées, priorités, capacité, transport fractionné, fusion et réévaluation. | Zones à plusieurs cellules, désignation rectangulaire, noms et politiques partagées ; filtres riches avec les futurs objets. |

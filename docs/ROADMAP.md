...
V62 — [réveils défensifs](development/disturbance.md) : impacts audibles, posture et sommeil distincts, réaction civile après réveil et délais persistants ; prolonge l’approche ennemie V61 et le tir automatique V60. Combat encore partiel ; aucun jalon G0–G5 déclaré clos.
...
**Prochaine livraison visée : premiers vêtements portés et protection corporelle.** Relire couches, groupes anatomiques, compatibilité, équipement/retrait physiques et calcul d’armure avant de choisir un premier contenu réduit mais réellement obtenable. Prévoir la même identité visuelle carte/portrait, conservation et reprise ; ne pas multiplier les définitions sans boucle d’acquisition. V62 livre les réveils sous impacts et dommages ; la réévaluation complète des autres travaux aux dommages, les autres bruits et souvenirs restent distincts. V61 fournit toujours seulement une approche de cibles visibles : raids, tactique/retraite de groupe, objectifs invisibles et besoins NPC complets restent ouverts. Puis pensées/relations selon leurs producteurs, sans approfondir encore l’électricité. [Contrat V62](development/disturbance.md), [preuves](history/validation-disturbance-v62.md).

**Lot habillement engagé, préparation sous V62 :** corpus et classes Wear/Remove/Armor relus ; noyau isolé de couverture/protection testé. Pas de nouveau schéma, objet ni boucle jouable. Continuer avec les instances physiques, les commandes et les consommateurs de dégâts avant le prochain bilan de fonctionnalité ; [contrat et points de branchement](development/armor.md).

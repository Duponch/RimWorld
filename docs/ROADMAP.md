...
V55 — [vols et impacts persistants dans World](development/projectiles.md), encore alimentés par des fixtures d'émission. La mobilisation et les déplacements V53 restent la dernière nouvelle commande jouable. Prochain branchement précis : préparation/récupération du tireur, Tir/XP et commande visible consommant ces vols, puis adversaire et réactions civiles. Ne pas ajouter une attaque instantanée générique. Aucun jalon G0–G5 déclaré clos.

Incréments du lot : [ligne/couvert/visée](development/combat-queries.md), [profils et précision](research/ranged-statistics-reference.md), [impacts V54](development/bullet-impact.md) et [captures du décor](development/combat-world.md). V55 ajoute de vraies sauvegardes World pendant les vols, l'ordre des sous-pas/impacts, la publication des phases et le retrait distant des collections sparse. L'audit intégré expose puis réduit les recaptures de carte après chaque blessure ; les pointes résiduelles restent dans les preuves. Restent le producteur d'XP/Tir, les phases du tireur, la commande et l'adversaire ; objets endommagés et dépouilles demandent leurs contrats. Brancher ces dépendances en un parcours visible. Ces sous-étapes ne constituent toujours pas du combat jouable.
...
**Mode jour rétabli le 18 septembre à la demande utilisateur.** La reprise automatique de nuit est suspendue ; terminer un lot cohérent, commit/push et bilan, puis attendre la prochaine instruction. Le dernier lot de code V55 est publié (`37a6791`) ; aucune étape de code inachevée à terminer lors de ce retour.

**Prochaine livraison visée : premier tir commandé et visible.** Regrouper intention/phases du tireur, compétence Tir avec effet réel et XP, commande revalidée, orientation/présentation et projectile V55 dans un parcours joueur. Critère : colon équipé et mobilisé, ordre accepté ou refus motivé, préparation interruptible, émission, récupération, impact médical au bon instant, secours/soins déjà présents et reprise pendant chaque phase. Contrôler mouvement et changement de cible pendant récupération sans permettre de cadence artificielle. L'adversaire avec appartenance, collision et réaction civile forme la tranche suivante ; ne pas appeler « raid » un adversaire de scénario. Les recherches d'interruption sont [consignées ici](research/combat-preparation.md#préparation-et-récupération--relecture-du-18-septembre).
...
| Compétences, traits et identité | 15–25 % | Construction et Médecine actives ; dix autres compétences, biographies, traits et effets croisés absents. |
...
| Combat | 5–15 % | Fondations balistiques/anatomiques testées ; aucun échange de tirs jouable. Commandes, phases, ennemis, réactions, mêlée et protections à intégrer. |

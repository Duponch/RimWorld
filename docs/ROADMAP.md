...
3. **Compléments de G1, puis habitat G2** : réinstallation après la déconstruction V24, puis minage/chaîne de la pierre ; autres recettes, ateliers, statistiques utiles et catalogue progressivement enrichi. Portes/toits/pièces, températures variables et chaîne du froid restent ouverts. Le feu ne chauffe pas encore les pièces.

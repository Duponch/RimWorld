...
État : **19 septembre 2026, après V67**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).

Dernière fonctionnalité publiée : [ouvrages endommagés et réparation V67](development/barriers.md). Murs/portes destructibles, bilan des pertes, zone de foyer et entretien physique. [Preuves V67](history/validation-barriers-v67.md). Première dépendance visible de l’étape 2, **qui reste ouverte** : aucun nouvel incident hostile ni attaque autonome de barrière. L’accueil V66 reste livré.
...
**Prochaine livraison visée : une menace et ses conséquences dans le camp ordinaire.** V66 a livré la première ligne de population ci-dessous ; V67 a livré les dégâts et réparations des murs/portes. Le prochain lot doit intégrer l’incident hostile, la recherche d’accès au camp fermé, son issue et les victimes, sans approfondir tout le catalogue de dégâts avant ce résultat. Vérifier les incidents hostiles Core et leurs issues avant code. La boucle doit fonctionner sur un camp fermé et se terminer par des conséquences réelles ; dégâts aux ouvrages, accès et devenir des victimes sont des dépendances à examiner ensemble, sans ouvrir tout le catalogue de factions. La scène de rencontre actuelle seule ne suffit pas.

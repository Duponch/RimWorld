...
État : **19 septembre 2026, après V68**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).

Dernière fonctionnalité publiée : [premier raid du camp V68](development/raids.md). Alerte dans la colonie ordinaire, approche depuis le bord, brèche physique, issue et retrait réel, victimes conservées et reprise du travail. [Preuves V68](history/validation-raids-v68.md). Calendrier/composition provisoires ; corps transportables, capture et narrateur complet restent ouverts. V66 accueil et V67 ouvrages restent livrés.
...
**Prochaine livraison visée : quelques différences de caractère réellement actives.** La première boucle de menace ordinaire est livrée en V68, sans fermer le devenir complet des victimes. Revue après accueil/ouvrages/raid : le joueur voit désormais une arrivée et un assaut dans son propre camp ; ne pas approfondir par inertie toutes les compositions d’ennemis avant les personnes et la progression matérielle. Prochain lot : petit ensemble de traits Core cohérents avec besoins/humeur/travail déjà présents, inspectables et persistants, puis première interaction/opinion ayant une conséquence réelle selon dépendances. Vérifier les règles avant de choisir les traits ; ni catalogue complet ni biographies inventées. Corps, capture, autres stratégies et narrateur restent explicitement prévus dans les domaines ci-dessous.
...
Descriptions factuelles corrigées le 19 septembre après V65 ; fourchettes de charge conservées comme hypothèses historiques, sans nouvelle mesure de vélocité ni date de fin réengagée. La revue stratégique ne transforme pas ces pourcentages en mesures objectives.
...
| Compétences, traits et identité | 15–25 % | Construction, Médecine, Tir et Mêlée actifs ; huit autres compétences, biographies, traits et effets croisés absents. |
...
| Combat | 5–15 % | Tir, santé, pouvoir d’arrêt et sentinelle de scénario désormais jouables ; Fuir/Attaquer/Ignorer et collisions intégrés. Mêlée V59, tir automatique/Attaquer V60 et approche ennemie visible V61 livrés ; protection corporelle V63 et réveils V62 présents ; stratégies de groupe, dégâts au décor, dépouilles et raids restent absents. |
| Humeur et relations | 5–10 % | Humeur causale progressive V64, premières pensées/mémoires et errance triste V65 ; autres crises, attentes variables, personnalités et réseau social absents. |

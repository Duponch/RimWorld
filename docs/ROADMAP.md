...
État : **19 septembre 2026, après V78**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).

Dernière fonctionnalité publiée : [mêlée interespèces V78](development/animal-melee.md), ordre au contact dans Faune, riposte/morsures, blessures humaines soignables, approche locale et récupération persistante. Le noyau de contact auparavant humain est partagé sans anatomie humaine fictive. Cette dépendance visible complète les tirs V77 ; la filière alimentaire animale reste absente. [Preuves](history/validation-animal-melee-v78.md).
...
**Prochain lot visé : chasse → dépouille → viande → repas.** Anatomie/tirs/fuite V77 et riposte de mêlée V78 sont livrés. Le prochain progrès doit enfin produire une filière alimentaire jouable : travail de chasse, achèvement admissible, corps conservant identité/état/fraîcheur, transport et boucherie puis emploi culinaire. Ne plus prolonger la préparation du combat animal, ni ajouter d'espèce avant cette boucle. Les morts sur place sont encore une limite concrète à lever. Élevage/dressage/écologie viennent ensuite. Dette froide : gelures, pensées et danger des lits ; saisons attendent mortalité végétale/protection/chauffage.
...
## Estimation d'avancement — revue du 19 septembre 2026, V78
...
La revue remplace les anciens chiffres figés du 18 septembre : ils sous-décrivaient déjà le combat, les personnes et, après V76/V77, la faune. Le passage de l'estimation centrale 20 à 25 % reflète cette relecture et les boucles effectivement intégrées depuis ; **V78 seule n'a pas réalisé cinq points du jeu**. Les domaines ont des poids différents, des dépendances communes et des coûts de catalogue très inégaux : ne pas calculer la moyenne des lignes. Les fourchettes ci-dessous donnent l'incertitude de jugement, pas une mesure statistique.
...
| Transport et stockage | 55 % (45–65) | Piles physiques, filtres, portage, paquets et inachevés | Étagères, zones nommées/politiques riches, masse, dépouilles, inventaire personnel |
...
| Cuisine et alimentation | 40 % (30–50) | Ingrédients réels, factures, combustible, repas portés puis consommés | Chasse/boucherie/viandes, cuisine étendue, intoxications et autres filières |
| Conservation et chaîne du froid | 55 % (45–65) | Âges conservés, pourriture, température locale, réserve froide obtenable | Corps/viandes et autres produits, équipements et politiques associés |
...
| Compétences, traits et identité | 35 % (25–45) | Sept compétences actives, six traits avec effets, profils d'arrivants | Autres compétences/traits, biographies/incapacités, variété des profils |
...
| Animaux, chasse et élevage | 15 % (10–20) | Une espèce adulte, besoins, anatomie, tirs/fuite et mêlée/riposte | Chasse alimentaire, dépouilles/boucherie, autres espèces, élevage/dressage/reproduction |

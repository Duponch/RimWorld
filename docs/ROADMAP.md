...
3. **Compléments de G1, puis habitat G2** : compléments logistiques des meubles après la réinstallation V25, puis minage/chaîne de la pierre ; autres recettes, ateliers, statistiques utiles et catalogue progressivement enrichi. Portes/toits/pièces, températures variables et chaîne du froid restent ouverts. Le feu ne chauffe pas encore les pièces.
...
Le lot V25 ajoute retrait, portage et pose du même meuble ; sa logistique automatique reste partielle. Le lot V24 a ajouté retrait physique et récupération. L’audit de 100 colons a réduit une partie des pointes graphiques du premier dépôt en préparant les lots au chargement ; des pointes résiduelles et les limites du planner à charge mixte restent mesurées dans [validation](development/validation.md). Ces budgets doivent être revérifiés avec le minage et les futurs ateliers.

...
État : **19 septembre 2026, après V69**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).

Dernière fonctionnalité publiée : [six traits actifs V69](development/traits.md), avec cible d’humeur, seuils personnels, apprentissage et inspection ; nouvelles offres cohérentes, sauvegardes anciennes neutres. [Preuves V69](history/validation-traits-v69.md). Première tranche de l’étape 3 ; les interactions/opinions ne sont pas encore livrées. Accueil V66, ouvrages V67 et raid V68 restent jouables.
...
**Prochaine livraison visée : premières interactions et opinions ayant une conséquence observable.** V69 livre la partie traits de l’étape 3. Choisir un petit ensemble d’échanges Core après vérification de proximité, capacités, interruptions, cumul, durée et effets dirigés ; montrer les causes à l’inspection. Ne pas prolonger par un catalogue de traits ou tout le système amoureux. Critère d’arrêt de l’étape 3 : une situation ordinaire entre colons produit un effet relationnel/humeur expliqué, persisté et testé, puis passer à la production utile de l’étape 4. Corps, capture et narrateur restent prévus, sans approfondir les compositions de raid par inertie.
...
| 3 — Personnes distinctes : traits V69 livrés, interactions à suivre (G1/G3) | Des différences de caractère et premières interactions/opinions changent les affectations ou l’humeur, avec causes inspectables. | Petit ensemble de traits/interactions Core réellement actifs ; ne pas enchaîner tout le catalogue de psychologie avant la progression matérielle. |
...
Descriptions factuelles corrigées le 19 septembre après V69 ; fourchettes de charge conservées comme hypothèses historiques, sans nouvelle mesure de vélocité ni date de fin réengagée. La revue stratégique ne transforme pas ces pourcentages en mesures objectives.
...
| Humeur et relations | 5–10 % | Humeur causale progressive V64, premières pensées/mémoires, errance triste V65 et six traits V69 ; autres crises, attentes variables, autres personnalités et réseau social absents. |

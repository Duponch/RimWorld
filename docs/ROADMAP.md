...
État : **20 septembre 2026, ensemble V87 validé dans son périmètre**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil et la captivité, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).
...
**Ensemble suivant : échanges et économie locale.** Réunir visiteurs et inventaires physiques, valeur et monnaie, contact commercial, transaction conservatrice de panier, achat utile puis départ. Préparer leurs références ensemble et attribuer les sous-domaines indépendants avant intégration ; ne pas ouvrir seulement un écran de commerce. Cette chaîne n'est pas implémentée par V87. Monde/caravanes, diplomatie complète et catalogue de tous les marchands restent distincts. Choisir le parcours commun selon ces échanges et leurs invariants, sans attendre automatiquement une année ; profilage moteur/diagnostics et charge mixte en parallèle du développement. Mode jour : retour après publication de V87, puis prochaine instruction.
...
| 2 — Faire évoluer la colonie : captivité V86 livrée | Capture d’un assaillant blessé, prison, soins/nourriture, résistance et recrutement conservant la personne ; vrai camp agrandi à quatre. | Cassandra ne sélectionne encore que des raids. Événements non hostiles, commerce, intention démographique, indéfectibles, diplomatie et devenir des corps humains restent ouverts. |
...
| 4 — Échanges et économie locale, prochain ensemble | Visiteurs, possessions, monnaie, prix et panier transactionnel jusqu'à un achat utile et un départ physique. | Recherche préparatoire seulement ; contrats d'identité, propriété, accès, reprise et prix à confronter au Core avant implémentation. Pas de caravane mondiale implicite. |
...
Revue du 20 septembre 2026 : domaines V87 réévalués selon les fonctions validées, estimation globale conservée. Ces jugements restent incertains et portent sur des fonctions, jamais sur un pourcentage de temps restant.
...
| Construction et entretien | 50 % (40–60) | Matériaux, plan/cadre, dégagement, déconstruction, réinstallation ; dégâts et réparation des bâtiments présents livrés en V87 | Sols, catalogue étendu, qualité/échecs, toutes les causes de panne/dégât |
...
| Agriculture et végétation utile | 40 % (30–50), révisé V87 | Riz, pommes de terre, maïs, coton, récoltes renouvelées ; lumière saisonnière et survie végétale livrées en V87 | Nombreuses espèces, maladies végétales, croissance des arbres et biomes différenciés |
...
| Combat direct et défense | 40 % (30–50) | Mobilisation, tir/LOS/couvert, mêlée, protection, approches, brèches, riposte animale et capture des blessés | Armes/stratégies, groupes plus complets, explosifs, tourelles, corps humains |
...
| Génération des sites, sols et biomes | 35 % (25–45) | Carte 250², scénario partiel, relief choisi, sols fertiles, pierres/filons et fragments physiques ; végétation/faune partielles, un climat référencé livré en V87 | Diversité des biomes, géographie/ressources, sélection climatique mondiale, cartes spéciales |

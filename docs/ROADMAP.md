...
État : **19 septembre 2026, après V75**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).

Dernière fonctionnalité publiée : [conservation froide V75](development/cold-store.md), recherche et construction d’un climatiseur, stockage physique au gel, coupure et reprise du vieillissement ; exposition corporelle froide réelle. [Preuves](history/validation-cold-store-v75.md). La canicule V74 et ses protections restent livrées. La recherche et le tailleur V73 donnent toujours un projet collectif puis une chemise confectionnée et portée dans le camp. L’étape proche 4 est satisfaite par cette boucle, sans terminer l’arbre technologique ni le catalogue. [Preuves](history/validation-research-v73.md). Accueil, menace et première différenciation des personnes restent livrés dans leurs périmètres annoncés.
...
**Prochain lot visé : première faune et chasse utile au camp.** Décision nouvelle : choisir une proie accessible, mobiliser un chasseur équipé et obtenir une ressource alimentaire au terme d’une chaîne physique. Avant code, vérifier espèces/corps, comportement de fuite ou riposte, chasse, cadavre transportable et boucherie Core ; ne pas réutiliser les paramètres humains sans justification. Découper si nécessaire en livraisons visibles, avec un animal vivant autonome comme premier résultat, puis chasse → dépouille → viande → repas. Invariants : identité du corps, conservation, blessures réelles et réservations. Élevage, dressage et catalogue animal complet restent ultérieurs. Réexaminer la progression à l’issue de cette première filière ; ne pas ouvrir tous les détails électriques ou sociaux par inertie. La dette froide (gelures localisées, pensées et danger des lits) reste explicite ; saisons attendent aussi mortalité végétale/protection/chauffage.

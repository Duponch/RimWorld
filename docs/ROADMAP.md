...
3. **Compléments de G1, puis habitat G2** : identités géologiques V27 livrées ; prochain lot : minage physique, sol découvert et produits, puis chaîne de la pierre après les transferts et la logistique V25–V26 ; autres recettes, ateliers, statistiques utiles et catalogue progressivement enrichi. Portes/toits/pièces, températures variables et chaîne du froid restent ouverts. Le feu ne chauffe pas encore les pièces.

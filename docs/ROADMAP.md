...
État : **20 septembre 2026, V83 validée**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).

Dernière boucle : [site local et première récolte V83](development/world-generation.md), trois reliefs, sols fertiles et ressources physiques reliés au départ. Douze jours joués avec abri, défense, riz récolté puis cuisiné ; anciennes cartes préservées. L'autonomie alimentaire durable reste à développer. [Preuves V83](history/validation-site-v83.md).

Boucle médicale précédente : [infection de plaie V81](development/infections.md), progression et immunité consultables, soins physiques renouvelés, besoins et récupération persistés. [Preuves](history/validation-infections-v81.md). Autres maladies, chirurgie et soins vétérinaires restent absents.
...
**Limites de charge V83 :** audit mixte de cent colons et cent lièvres initiaux, CPU p95 84,48 ms ; rendu p95 29,2 ms, maximum 62,5 ms ; débit 22,08 ticks/s pour 36 demandés. Recherche animale et tirs restent à profiler. Les premiers repas renouvelables sont obtenus à J7 sur le site joué, mais une seule ration reste à J12 : la production durable reste la priorité suivante. [Preuves et conditions](history/validation-site-v83.md).
...
**Critère d'arrêt :** lancement et chargement véritables, choix actifs reliés à leurs règles, autres choix grisés, preuves groupées de conservation/continuation et vraie UI. Les parcours durent le temps nécessaire pour observer les transitions naturelles : aucune injection du pilote pour forcer raid, récolte ou maladie avant sept jours ; respecter l’occasion normale du raid introductif à 5,4 jours lorsque ses conditions sont réunies. Un point non vérifiable demande une vérification précise dans le jeu. Le [témoin utilisateur 1.6.4871](research/map-calibration-reference.md#témoin-actuel-fourni-par-lutilisateur) est reçu et mesuré : forêt boréale/grandes collines, sans tutoriel, profil demandé ; il permet d'avancer sur les écarts certains sans prétendre définir une distribution moyenne. Saisons, pluie/incendies, espèces, prisonniers, commerce et monde restent distincts.

| Prochain ensemble | Manques constatés et résultat jouable attendu | Limite et dépendances à vérifier avant code |
|---|---|---|
| 1 — Installer une production alimentaire durable | Seules cuisine au feu, boucherie au sol et deux cultures existent ; la faim ne cause encore ni malnutrition ni décès. Réunir vrais postes de cuisine/boucherie, récoltes et production adaptées à la population, conséquences de la faim, salissures/nettoyage et risques alimentaires vérifiés ; plusieurs cycles récoltés, cuisinés, conservés et consommés. | Réutiliser factures, matières, chaîne du froid, santé et priorités. Vérifier les règles Core de propreté/intoxication et les postes ; ne pas ajouter un vaste catalogue de recettes ni promettre l'autonomie avec vingt cases. Si la propreté dépasse ce périmètre, retenir une filière complète et motiver la frontière. |
| 2 — Rendre l'habitat et l'énergie évolutifs | Réseau électrique local encore adapté, aucun conduit/batterie/interrupteur ; dégâts limités aux barrières. Relier réseau construit, stockage de l'énergie, coupures et entretien aux ateliers et réserves réels. | Coûts, pannes, pertes et réparations recherchés ensemble. Ajouter incendie/extinction seulement comme boucle complète explicitement cadrée ; ne pas confondre un effet visuel avec un danger joué. |
| 3 — Faire évoluer la colonie et ses conséquences | Cassandra ne sélectionne que des raids, population du nouveau profil figée ; commerce, prisonniers et corps humains absents. Réunir une famille d'événements non hostiles et l'entrée physique de nouvelles personnes, puis une première conséquence complète des rencontres (échange ou prise en charge/capture selon dépendances). | Conditions et chronologie du narrateur fondées sur les classes/Defs et observations. Argent utile et échanges conservatifs si commerce retenu ; statut, besoins et soins si capture retenue. Ni globe décoratif ni moteur de quêtes général comme préalable. |
| 4 — Traverser des saisons réelles | Température quotidienne fixe, aucune saison ni mortalité végétale. Relier climat du site, culture interrompue/reprise, chauffage, vêtements et réserves à un cycle saisonnier observé. | Recherches de calendrier/latitude/croissance communes ; conserver les climats historiques. Monde complet et biomes multiples différés, horizon dicté par la saison et non J7. |
...
Revue du 20 septembre 2026, V82 ; estimation globale conservée.
...
| Anatomie, santé, secours et soins | 50 % (40–60) | Lésions/capacités, saignement, secours, soins/médicaments, chaleur/froid, infection localisée/immunité et soins prolongés | Autres maladies, chirurgie, implants, soins animaux, hôpital/propreté complets et devenir des corps humains |

...
État : **19 septembre 2026, après V76**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).

Dernière fonctionnalité publiée : [première faune autonome V76](development/wildlife.md), lièvres vivants qui broutent/mangent et dorment, liste Faune. La chasse n’est pas encore disponible. [Preuves](history/validation-wildlife-v76.md).
...
**Prochain lot visé : anatomie animale et chasse → dépouille → viande → repas.** V76 livre la première tranche visible autorisée : des lièvres autonomes, avec alimentation réelle et sommeil. Le profil est séparé des colons ; santé, mortalité, riposte/fuite et renouvellement restent absents et doivent être ajoutés avant d'ouvrir la chasse. Relire le corps quadrupède, les attaques, la fuite sous tirs et les règles de faim/mort ; ne pas réduire une victime à un compteur global de PV. Identité du corps, transport physique, réservations et boucherie restent indispensables à la filière. Élevage, dressage et catalogue animal complet viennent ensuite. Réexaminer la progression après cette filière ; ne pas prolonger la seule promenade animale par inertie. Dette froide : gelures, pensées et danger des lits ; saisons attendent aussi mortalité végétale/protection/chauffage.

...
État : **20 septembre 2026, après V80**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).

Dernière boucle : [départ Trois survivants V80](development/scenario-start.md), scénario explicite, vraie dotation, technologies initiales et implantation sur terrain naturel. Camp pédagogique conservé ; premiers jours éprouvés sans retirer les provisions pour forcer une urgence. Catalogue et difficulté restent partiels. [Preuves V80](history/validation-scenario-v80.md). La [filière animale V79](development/hunting.md) relie toujours chasse, dépouille, boucherie et repas. [Preuves V79](history/validation-hunting-v79.md).
...
**Prochain lot visé : risque sanitaire après blessure et soins prolongés.** Donner une conséquence médicale observable aux affrontements : première infection de plaie, progression/immunité, besoin de soins et récupération ou aggravation expliqués. Vérifier précisément source d'infection, délais, qualité des soins, repos et immunité avant de fixer le périmètre ; ne pas ajouter toutes les maladies/chirurgies en même temps. Les soins, médicaments et capacités anatomiques déjà livrés sont ses prérequis. Une nouvelle maladie ne doit pas réinitialiser ni simplifier les blessures existantes.

**Critère d'arrêt :** un blessé de la colonie peut réellement développer le risque retenu, recevoir des soins physiques pendant plusieurs journées et connaître une issue persistée/reproductible ; l'UI expose cause et progression. Le lot confirme d'abord sa dépendance aux règles de blessure actuelles. Saisons, pluie/incendies, catalogue d'espèces, prisonniers, commerce et scénario mondial restent des boucles distinctes ; cette priorité ne clôt pas la santé. Dette froide : gelures, pensées et danger des lits.
...
Revue du 20 septembre 2026, V80.

...
Le camp possède matériaux, construction, nourriture, repos, loisirs, toits, température locale et première électricité. V45 y ajoute capacités physiques, blessures et incapacité. V46 ajoute les secours physiques et lits médicaux. Il manque encore les traitements, l’alimentation assistée et les conflits. L’habitat a été approfondi trop longtemps avant ces boucles. L’ordre ci-dessous traverse les jalons selon leurs dépendances ; il ne faut pas finir chaque appareil de G2 avant de commencer G3.
...
3. **Secours et soins** : [transport du blessé, couchage médical et métier Médecin V46](development/rescue.md) livrés. Prochaine tranche : traitement physique sans médicament, repos médical volontaire et alimentation du patient ; puis médicaments/politiques selon leurs dépendances. Puis maladies et complications à mesure que leurs producteurs arrivent. [Recherche préparatoire et critères du prochain lot](research/care-preparation.md).

...
3. **Compléments de G1, puis habitat G2** : déconstruction et réinstallation, puis minage/chaîne de la pierre ; autres recettes, ateliers, statistiques utiles et catalogue progressivement enrichi. Portes/toits/pièces, températures variables et chaîne du froid restent ouverts. Le feu ne chauffe pas encore les pièces.

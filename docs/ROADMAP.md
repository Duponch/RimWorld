...
État : **19 septembre 2026, après V77**. ROADMAP est l’unique calendrier G0–G5. G0 en consolidation, G1/G2/G3 partiels, G4 engagé par l’accueil, G5 absent ; aucun jalon complet. Les numéros de schéma ne mesurent pas l’avancement du jeu. [Inventaire réel](gameplay/implementation-status.md), [preuves](development/validation.md), [index](README.md).

Dernière fonctionnalité publiée : [santé animale et tirs V77](development/animal-combat.md), lésions réelles, fuite, incapacité/mort et inspection. La chasse automatique et la filière alimentaire animale ne sont pas disponibles. La généralisation des contrats anatomiques et balistiques, auparavant exclusivement humains, justifie cette tranche visible préalable. [Preuves](history/validation-animal-combat-v77.md).
...
**Prochain lot visé : riposte au contact et chasse → dépouille → viande → repas.** L'anatomie quadrupède, les blessures, la fuite sous tirs et la mort sont ajoutées en V77 ; la généralisation des contrats auparavant humains justifie cette tranche préalable. La riposte de mêlée interespèces reste nécessaire avant la chasse automatique ; ne pas la confondre avec le manhunter, nul chez le lièvre. Identité du corps, transport physique, réservations, fraîcheur et boucherie sont indispensables à la filière. Viser ensemble leurs sous-étapes, puis réexaminer la progression ; ne pas ajouter d'espèce ni prolonger les détails médicaux par inertie. Élevage, dressage et écologie viennent ensuite. Dette froide : gelures, pensées et danger des lits ; saisons attendent aussi mortalité végétale/protection/chauffage.
...
Descriptions factuelles corrigées le 19 septembre après V75 ; fourchettes de charge conservées comme hypothèses historiques, sans nouvelle mesure de vélocité ni date de fin réengagée. La revue stratégique ne transforme pas ces pourcentages en mesures objectives.
...
| Construction, logistique et habitat | 40–55 % | Matériaux, plans/cadres, transport, pièces/toits, lumière/température présents ; catalogue, réparations hors murs/portes/climatiseurs, sols, risques et électricité complète manquants. |
...
| Production, recherche et contenu | 10–20 % | Repas, blocs et filière coton→vêtement ; deux recherches au poste V73/V75, vêtement et climatiseur obtenables. Nombreux ateliers/recettes et arbre complet absents. Ce n'est pas un ratio d'objets : aucun catalogue exhaustif vérifié. |

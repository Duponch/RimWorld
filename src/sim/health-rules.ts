...
export const pawnBody=(pawn:Pawn):BodyAssessment=>pawn.health&&(pawn.health.injuries.length||pawn.health.missing.length||pawn.health.bloodLoss)?assessMedical(pawn.health):HEALTHY_BODY;

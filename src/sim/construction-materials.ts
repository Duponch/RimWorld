...
const costs:Record<StructureKind,number>={'research-bench':75,'tailor-bench':75,'crafting-spot':0,'wood-generator':100,'standing-lamp':20,'passive-cooler':50,door:25,stonecutter:75,wall:5,bed:45,table:28,stool:25,campfire:20,horseshoes:10};
const work:Record<StructureKind,number>={'research-bench':2800,'tailor-bench':2000,'crafting-spot':0,'wood-generator':2500,'standing-lamp':300,'passive-cooler':200,door:850,stonecutter:2000,wall:135,bed:800,table:750,stool:450,campfire:200,horseshoes:100};
...
export function validConstructionMaterial(kind:unknown,material:unknown,version=73):boolean {

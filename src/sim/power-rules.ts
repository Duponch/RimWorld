...
export const isPowerTrader=(kind:unknown):boolean=>kind==='wood-generator'||kind==='solar-generator'||kind==='wind-turbine'||kind==='heater'||kind==='standing-lamp'||kind==='cooler'||kind==='electric-stove';
...
export const powerDemand=(s:Structure):number=>s.kind==='electric-stove'?350:s.kind==='cooler'?(s.cooler?.high?200:20):s.kind==='heater'?(s.heater?.high?175:17.5):s.kind==='standing-lamp'?LAMP_DEMAND:0;

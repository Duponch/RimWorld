...
export const isElectrical=(kind:unknown):boolean=>kind==='wood-generator'||kind==='standing-lamp';
...
export const powerWatts=(s:Structure):number=>!isPowerActive(s)?0:s.kind==='wood-generator'?POWER_OUTPUT:s.kind==='standing-lamp'?-LAMP_DEMAND:0;

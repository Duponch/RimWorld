...
export type ProductionIngredient = 'steel'|'component'|'unfinished-gun'|'rice'|'berries'|'agave-fruit'|'potato'|'corn'|typeof ANIMAL_MEAT_ITEMS[number]|typeof ANIMAL_CORPSE_ITEMS[number]|TailoringMaterial|UnfinishedApparelItem|StoneIngredient;
export type ProductionRecipe = GunRecipe|'simple-meal'|'stone-blocks'|TailoringRecipe|'butcher-creature';

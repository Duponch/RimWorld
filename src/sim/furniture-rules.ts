...
export const minifiable = (kind: string): boolean => ['heater','battery','fueled-stove','electric-stove','butcher-table','research-bench','tailor-bench','bed','table','stool','horseshoes','stonecutter','standing-lamp'].includes(kind);

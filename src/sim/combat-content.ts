...
export const STRUCTURE_SHOT_FILL:Readonly<Record<StructureKind,number>>=Object.freeze({'art-bench':.5,'small-sculpture':.35,'large-sculpture':.5,grave:0,heater:.4,'wind-turbine':.5,

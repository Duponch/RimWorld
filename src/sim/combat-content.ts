...
export const STRUCTURE_SHOT_FILL:Readonly<Record<StructureKind,number>>=Object.freeze({
  'research-bench':.5,'tailor-bench':.5,wall:1,door:1,  'crafting-spot':0,'wood-generator':1,stonecutter:.5,bed:.4,table:.4,

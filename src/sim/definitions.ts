...
type FootprintEntity = Cell & { kind: JobKind | StructureKind; orientation?: Orientation; footprint?: Footprint };
...
export function footprintContains(entity: FootprintEntity, cell: Cell): boolean {
  ...
  if((entity.kind!=='bed'&&entity.kind!=='table')||entity.footprint==='legacy-single')return false;

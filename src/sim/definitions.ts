...
export const JOB_DURATION: Readonly<Record<JobKind, number>> = Object.freeze({ chop: 100, harvest: 60, wall: 70, bed: 120, table: 53, stool: 32 });
export const JOB_WOOD_COST: Readonly<Record<JobKind, number>> = Object.freeze({ chop: 0, harvest: 0, wall: 5, bed: 8, table: 28, stool: 25 });

...
export const SCENARIOS=Object.freeze({
  crashlanded:Object.freeze({label:'Atterrissage forcé',revision:4 as const,minSize:32,description:'Adaptation partielle : trois personnes, 300 bois, 450 acier, 30 composants, 50 repas de survie, 30 médicaments, 800 argent, un fusil à verrou, un revolver, un couteau en plastacier, trois chemises et un gilet. Cassandra et Récit d’aventure partiels ; protections supplémentaires, animal familier et débris dispersés restent absents.'}),
...
export interface ScenarioStamp {id:ScenarioId;revision:1|2|3|4;landing:Cell}

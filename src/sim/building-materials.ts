...
export type ConstructionMaterial = 'wood' | 'steel' | BlockMaterial;
...
export const CONSTRUCTION_MATERIALS: readonly ConstructionMaterial[] = Object.freeze(['wood','steel',...BLOCK_MATERIALS]);

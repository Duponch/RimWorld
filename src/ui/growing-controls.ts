...
export function growingControls(zone: GrowingZone, send: (command: Command) => void): HTMLElement {
  ...
  help.textContent=zone.plant==='cotton'?'Le coton mûr donne 10 tissus. Cycle de croissance plus long que le riz ; le tissu se stocke comme matériau. Confection non disponible pour le moment.':'Le riz mûr donne 6 unités alimentaires.';
  panel.append(help);

...
export const buildingLabels: Readonly<Record<StructureKind, string>> = {
  ...
  'machining-table':'Atelier d’usinage', cooler: 'Climatiseur', 'research-bench': 'Bureau de recherche', 'tailor-bench': 'Établi de tailleur', 'electric-tailor-bench':'Établi de tailleur électrique',
  ...
  stonecutter: 'Table de taille de pierre', wall: 'Mur', bed: 'Lit', table: 'Table 1 × 2','table-square':'Table 2 × 2','table-long':'Table 2 × 4',

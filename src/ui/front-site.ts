...
export function createSiteConfiguration(options: SiteConfigurationOptions): { element: HTMLElement; seedInput: HTMLInputElement } {
  ...
  root.innerHTML = `<section class="front-card front-site-controls"><p class="front-kicker">SITE LOCAL</p><h2>Choisir le terrain</h2>
    <p>Installez-vous en forêt tempérée. Le relief détermine la présence des massifs rocheux et des filons.</p>
    ...
    </section><section class="front-card front-summary"><p class="front-kicker">VOTRE SITE</p><h2>Forêt tempérée</h2>
    ...
    <p class="front-small">La planète, les autres biomes et les cours d’eau ne sont pas encore disponibles dans ce départ.</p>

...
- Lire docs/development/presentation-timing.md. Les vitesses positives s’appliquent dès confirmation à la prochaine frame, sans changer le curseur ni réamorcer le tampon. Quatre ticks confirmés seulement au démarrage/reprise vidée ; publication en fin de lot actif de 20 ms en plus des phases. FixedClock consomme le temps à l’ancien taux avant changement et conserve les fractions. Seul RAF avance la présentation.

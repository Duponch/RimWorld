...
- La scène des candidats doit refléter mutations/relations/recouvrement ; la capture du meilleur couvert ne la remplace pas. Prochain branchement : adaptateur complet, phases et migration stricte, vraie commande/XP, observateur de présentation et adversaire, avec garde UI et charge mixte. Les coûts de lots de vols complets ne sont pas des coûts par frame.

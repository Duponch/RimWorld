...
Le [guide joueur](docs/gameplay/player-guide.md) décrit contrôles, priorités et règles. Les sauvegardes utilisent actuellement le schéma 47 ; les anciennes versions sont validées puis migrées, sans agrandir leur carte ni remplacer leurs objets. La fraîcheur des aliments, les pertes par pourriture, le bilan de déconstruction et les dégâts du minage sont persistés. Les [premiers soins](docs/development/tending.md) ajoutent traitements sans médicament, repos médical et Médecine aux secours physiques ; médicaments, alimentation assistée, équipement et combat restent à développer.

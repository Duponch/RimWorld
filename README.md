...
Le [guide joueur](docs/gameplay/player-guide.md) décrit contrôles, priorités et règles. Les sauvegardes utilisent actuellement le schéma 10 ; les anciennes versions sont validées puis migrées, sans agrandir leur carte ni remplacer leurs objets.

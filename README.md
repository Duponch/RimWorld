...
Le [guide joueur](docs/gameplay/player-guide.md) décrit contrôles, priorités et règles. Les sauvegardes utilisent actuellement le schéma 48 ; les anciennes versions sont validées puis migrées, sans agrandir leur carte ni remplacer leurs objets. La fraîcheur des aliments, les pertes par pourriture, le bilan de déconstruction et les dégâts du minage sont persistés. Les [premiers soins](docs/development/tending.md) ajoutent traitements sans médicament, repos médical et Médecine aux secours physiques ; [l’alimentation assistée](docs/development/feeding.md) apporte une portion réelle au patient. Médicaments, auto-soins, équipement et combat restent à développer.

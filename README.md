...
V60 : **tir automatique des colons mobilisés et réaction civile Attaquer**. Défense à l’arrêt, priorité au déplacement et trois politiques Fuir/Attaquer/Ignorer ; prolongent tir, mêlée et soins. La sentinelle optionnelle reste statique, le camp paisible reste le défaut. Poursuite ennemie, autres armes/armures, raids et grands systèmes de progression restent à développer. [Guide](docs/gameplay/player-guide.md), [contrat](docs/development/automatic-combat.md), [validation](docs/history/validation-automatic-combat-v60.md).
